 ...
 * 
 * @export
 * @interface DeleteTableBranchRequest
 */
export interface DeleteTableBranchRequest {
    /**
     * 
     * @type {Identity}
     * @memberof DeleteTableBranchRequest
     */
    identity?: Identity;
    /**
...
/**
 * Check if a given object implements the DeleteTableBranchRequest interface.
 */
export function instanceOfDeleteTableBranchRequest(value: object): value is DeleteTableBranchRequest {
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function DeleteTableBranchRequestFromJSON(json: any): DeleteTableBranchRequest {
    return DeleteTableBranchRequestFromJSONTyped(json, false);
}

export function DeleteTableBranchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteTableBranchRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteTableBranchRequestToJSON(json: any): DeleteTableBranchRequest {
    return DeleteTableBranchRequestToJSONTyped(json, false);
}

export function DeleteTableBranchRequestToJSONTyped(value?: DeleteTableBranchRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
