 ...
 * @export
 * @interface DeleteTableBranchResponse
 */
export interface DeleteTableBranchResponse {
    /**
     ...
     * @memberof DeleteTableBranchResponse
     */
...
/**
 * Check if a given object implements the DeleteTableBranchResponse interface.
 */
export function instanceOfDeleteTableBranchResponse(value: object): value is DeleteTableBranchResponse {
    return true;
}

export function DeleteTableBranchResponseFromJSON(json: any): DeleteTableBranchResponse {
    return DeleteTableBranchResponseFromJSONTyped(json, false);
}

export function DeleteTableBranchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteTableBranchResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteTableBranchResponseToJSON(json: any): DeleteTableBranchResponse {
    return DeleteTableBranchResponseToJSONTyped(json, false);
}

export function DeleteTableBranchResponseToJSONTyped(value?: DeleteTableBranchResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
