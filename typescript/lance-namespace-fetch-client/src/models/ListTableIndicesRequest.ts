 ...
 * 
 * @export
 * @interface ListTableIndicesRequest
 */
export interface ListTableIndicesRequest {
    /**
     * 
     * @type {Identity}
     * @memberof ListTableIndicesRequest
     */
    identity?: Identity;
    /**
...
/**
 * Check if a given object implements the ListTableIndicesRequest interface.
 */
export function instanceOfListTableIndicesRequest(value: object): value is ListTableIndicesRequest {
    return true;
}

export function ListTableIndicesRequestFromJSON(json: any): ListTableIndicesRequest {
    return ListTableIndicesRequestFromJSONTyped(json, false);
}

export function ListTableIndicesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTableIndicesRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ListTableIndicesRequestToJSON(json: any): ListTableIndicesRequest {
    return ListTableIndicesRequestToJSONTyped(json, false);
}

export function ListTableIndicesRequestToJSONTyped(value?: ListTableIndicesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
