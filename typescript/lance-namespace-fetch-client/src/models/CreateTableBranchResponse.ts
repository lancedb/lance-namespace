 ...
 * @export
 * @interface CreateTableBranchResponse
 */
export interface CreateTableBranchResponse {
    /**
     ...
     * @memberof CreateTableBranchResponse
     */
...
/**
 * Check if a given object implements the CreateTableBranchResponse interface.
 */
export function instanceOfCreateTableBranchResponse(value: object): value is CreateTableBranchResponse {
    return true;
}

export function CreateTableBranchResponseFromJSON(json: any): CreateTableBranchResponse {
    return CreateTableBranchResponseFromJSONTyped(json, false);
}

export function CreateTableBranchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateTableBranchResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateTableBranchResponseToJSON(json: any): CreateTableBranchResponse {
    return CreateTableBranchResponseToJSONTyped(json, false);
}

export function CreateTableBranchResponseToJSONTyped(value?: CreateTableBranchResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
