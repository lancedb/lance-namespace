 ...
 * 
 * @export
 * @interface ListTableTagsRequest
 */
export interface ListTableTagsRequest {
    /**
     * 
     * @type {Identity}
     * @memberof ListTableTagsRequest
     */
    identity?: Identity;
    /**
...
/**
 * Check if a given object implements the ListTableTagsRequest interface.
 */
export function instanceOfListTableTagsRequest(value: object): value is ListTableTagsRequest {
    return true;
}

export function ListTableTagsRequestFromJSON(json: any): ListTableTagsRequest {
    return ListTableTagsRequestFromJSONTyped(json, false);
}

export function ListTableTagsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTableTagsRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ListTableTagsRequestToJSON(json: any): ListTableTagsRequest {
    return ListTableTagsRequestToJSONTyped(json, false);
}

export function ListTableTagsRequestToJSONTyped(value?: ListTableTagsRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
