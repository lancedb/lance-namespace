 ...
 * 
 * @export
 * @interface ListTableBranchesRequest
 */
export interface ListTableBranchesRequest {
    /**
     * 
     * @type {Identity}
     * @memberof ListTableBranchesRequest
     */
    identity?: Identity;
    /**
...
/**
 * Check if a given object implements the ListTableBranchesRequest interface.
 */
export function instanceOfListTableBranchesRequest(value: object): value is ListTableBranchesRequest {
    return true;
}

export function ListTableBranchesRequestFromJSON(json: any): ListTableBranchesRequest {
    return ListTableBranchesRequestFromJSONTyped(json, false);
}

export function ListTableBranchesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTableBranchesRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ListTableBranchesRequestToJSON(json: any): ListTableBranchesRequest {
    return ListTableBranchesRequestToJSONTyped(json, false);
}

export function ListTableBranchesRequestToJSONTyped(value?: ListTableBranchesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
