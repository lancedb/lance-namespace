...
/**
 * Check if a given object implements the ListNamespacesRequest interface.
 */
export function instanceOfListNamespacesRequest(value: object): value is ListNamespacesRequest {
    return true;
}

export function ListNamespacesRequestFromJSON(json: any): ListNamespacesRequest {
    return ListNamespacesRequestFromJSONTyped(json, false);
}

export function ListNamespacesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListNamespacesRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ListNamespacesRequestToJSON(json: any): ListNamespacesRequest {
    return ListNamespacesRequestToJSONTyped(json, false);
}

export function ListNamespacesRequestToJSONTyped(value?: ListNamespacesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
