 ...
 * 
 * @export
 * @interface NamespaceExistsResponse
 */
export interface NamespaceExistsResponse {
     ...
     * @memberof NamespaceExistsResponse
     */
    context?: { [key: string]: string; };
}

/**
 * Check if a given object implements the NamespaceExistsResponse interface.
 */
export function instanceOfNamespaceExistsResponse(value: object): value is NamespaceExistsResponse {
    return true;
}

export function NamespaceExistsResponseFromJSON(json: any): NamespaceExistsResponse {
    return NamespaceExistsResponseFromJSONTyped(json, false);
}

export function NamespaceExistsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): NamespaceExistsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function NamespaceExistsResponseToJSON(json: any): NamespaceExistsResponse {
    return NamespaceExistsResponseToJSONTyped(json, false);
}

export function NamespaceExistsResponseToJSONTyped(value?: NamespaceExistsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
