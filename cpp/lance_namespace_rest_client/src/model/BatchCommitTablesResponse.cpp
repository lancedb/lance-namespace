...
BatchCommitTablesResponse::BatchCommitTablesResponse()
{
...
void BatchCommitTablesResponse::validate()
{
    // TODO: implement validation
}

web::json::value BatchCommitTablesResponse::toJson() const
{
...
bool BatchCommitTablesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("results"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CommitTableResult>> refVal_setResults;
...
void BatchCommitTablesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BatchCommitTablesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t BatchCommitTablesResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void BatchCommitTablesResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool BatchCommitTablesResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void BatchCommitTablesResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
std::vector<std::shared_ptr<CommitTableResult>> BatchCommitTablesResponse::getResults() const
{
    return m_Results;
}


void BatchCommitTablesResponse::setResults(const std::vector<std::shared_ptr<CommitTableResult>>& value)
{
    m_Results = value;
    m_ResultsIsSet = true;
}

bool BatchCommitTablesResponse::resultsIsSet() const
{
    return m_ResultsIsSet;
}

void BatchCommitTablesResponse::unsetResults()
{
    m_ResultsIsSet = false;
}
