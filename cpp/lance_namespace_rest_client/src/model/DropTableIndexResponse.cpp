...
DropTableIndexResponse::DropTableIndexResponse()
{
...
void DropTableIndexResponse::validate()
{
    // TODO: implement validation
}

web::json::value DropTableIndexResponse::toJson() const
{
...
bool DropTableIndexResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DropTableIndexResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DropTableIndexResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DropTableIndexResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void DropTableIndexResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool DropTableIndexResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void DropTableIndexResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
