...
DeleteTableBranchResponse::DeleteTableBranchResponse()
{
...
void DeleteTableBranchResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteTableBranchResponse::toJson() const
{
...
bool DeleteTableBranchResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteTableBranchResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteTableBranchResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DeleteTableBranchResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void DeleteTableBranchResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool DeleteTableBranchResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void DeleteTableBranchResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
