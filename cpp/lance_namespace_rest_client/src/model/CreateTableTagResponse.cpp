...
CreateTableTagResponse::CreateTableTagResponse()
{
...
void CreateTableTagResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateTableTagResponse::toJson() const
{
...
bool CreateTableTagResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTableTagResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTableTagResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateTableTagResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void CreateTableTagResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool CreateTableTagResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void CreateTableTagResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
