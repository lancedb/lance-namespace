...
CreateTableBranchResponse::CreateTableBranchResponse()
{
...
void CreateTableBranchResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateTableBranchResponse::toJson() const
{
...
bool CreateTableBranchResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTableBranchResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTableBranchResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateTableBranchResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void CreateTableBranchResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool CreateTableBranchResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void CreateTableBranchResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
