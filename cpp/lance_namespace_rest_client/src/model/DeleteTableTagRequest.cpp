...
void DeleteTableTagRequest::validate()
{
    // TODO: implement validation
}

web::json::value DeleteTableTagRequest::toJson() const
{
...
bool DeleteTableTagRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteTableTagRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteTableTagRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Identity> DeleteTableTagRequest::getIdentity() const
{
    return m_Identity;
}


void DeleteTableTagRequest::setIdentity(const std::shared_ptr<Identity>& value)
{
    m_Identity = value;
    m_IdentityIsSet = true;
}

bool DeleteTableTagRequest::identityIsSet() const
{
    return m_IdentityIsSet;
}

void DeleteTableTagRequest::unsetIdentity()
{
    m_IdentityIsSet = false;
}
std::map<utility::string_t, utility::string_t> DeleteTableTagRequest::getContext() const
{
    return m_Context;
}


void DeleteTableTagRequest::setContext(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Context = value;
    m_ContextIsSet = true;
}

bool DeleteTableTagRequest::contextIsSet() const
{
    return m_ContextIsSet;
}

void DeleteTableTagRequest::unsetContext()
{
    m_ContextIsSet = false;
}
std::vector<utility::string_t> DeleteTableTagRequest::getId() const
{
    return m_Id;
}


void DeleteTableTagRequest::setId(const std::vector<utility::string_t>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DeleteTableTagRequest::idIsSet() const
{
    return m_IdIsSet;
}

void DeleteTableTagRequest::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t DeleteTableTagRequest::getTag() const
{
    return m_Tag;
}


void DeleteTableTagRequest::setTag(const utility::string_t& value)
{
    m_Tag = value;
    m_TagIsSet = true;
}

bool DeleteTableTagRequest::tagIsSet() const
{
    return m_TagIsSet;
}

void DeleteTableTagRequest::unsetTag()
{
    m_TagIsSet = false;
}
