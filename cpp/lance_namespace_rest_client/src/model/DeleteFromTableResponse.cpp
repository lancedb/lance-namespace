...
void DeleteFromTableResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteFromTableResponse::toJson() const
{
...
bool DeleteFromTableResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteFromTableResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteFromTableResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DeleteFromTableResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void DeleteFromTableResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool DeleteFromTableResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void DeleteFromTableResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
int64_t DeleteFromTableResponse::getVersion() const
{
    return m_Version;
}

void DeleteFromTableResponse::setVersion(int64_t value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool DeleteFromTableResponse::versionIsSet() const
{
    return m_VersionIsSet;
}

void DeleteFromTableResponse::unsetVersion()
{
    m_VersionIsSet = false;
}
