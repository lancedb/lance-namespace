...
void CreateNamespaceRequest::validate()
{
    // TODO: implement validation
}

web::json::value CreateNamespaceRequest::toJson() const
{
...
bool CreateNamespaceRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateNamespaceRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateNamespaceRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Identity> CreateNamespaceRequest::getIdentity() const
{
    return m_Identity;
}


void CreateNamespaceRequest::setIdentity(const std::shared_ptr<Identity>& value)
{
    m_Identity = value;
    m_IdentityIsSet = true;
}

bool CreateNamespaceRequest::identityIsSet() const
{
    return m_IdentityIsSet;
}

void CreateNamespaceRequest::unsetIdentity()
{
    m_IdentityIsSet = false;
}
std::map<utility::string_t, utility::string_t> CreateNamespaceRequest::getContext() const
{
    return m_Context;
}


void CreateNamespaceRequest::setContext(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Context = value;
    m_ContextIsSet = true;
}

bool CreateNamespaceRequest::contextIsSet() const
{
    return m_ContextIsSet;
}

void CreateNamespaceRequest::unsetContext()
{
    m_ContextIsSet = false;
}
std::vector<utility::string_t> CreateNamespaceRequest::getId() const
{
    return m_Id;
}


void CreateNamespaceRequest::setId(const std::vector<utility::string_t>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool CreateNamespaceRequest::idIsSet() const
{
    return m_IdIsSet;
}

void CreateNamespaceRequest::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t CreateNamespaceRequest::getMode() const
{
    return m_Mode;
}


void CreateNamespaceRequest::setMode(const utility::string_t& value)
{
    m_Mode = value;
    m_ModeIsSet = true;
}

bool CreateNamespaceRequest::modeIsSet() const
{
    return m_ModeIsSet;
}

void CreateNamespaceRequest::unsetMode()
{
    m_ModeIsSet = false;
}
std::map<utility::string_t, utility::string_t> CreateNamespaceRequest::getProperties() const
{
    return m_Properties;
}


void CreateNamespaceRequest::setProperties(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Properties = value;
    m_PropertiesIsSet = true;
}

bool CreateNamespaceRequest::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void CreateNamespaceRequest::unsetProperties()
{
    m_PropertiesIsSet = false;
}
