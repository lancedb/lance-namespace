...
CreateTableVersionResponse::CreateTableVersionResponse()
{
...
void CreateTableVersionResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateTableVersionResponse::toJson() const
{
...
bool CreateTableVersionResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTableVersionResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTableVersionResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateTableVersionResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void CreateTableVersionResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool CreateTableVersionResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void CreateTableVersionResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
std::shared_ptr<TableVersion> CreateTableVersionResponse::getVersion() const
{
    return m_Version;
}


void CreateTableVersionResponse::setVersion(const std::shared_ptr<TableVersion>& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CreateTableVersionResponse::versionIsSet() const
{
    return m_VersionIsSet;
}

void CreateTableVersionResponse::unsetVersion()
{
    m_VersionIsSet = false;
}
