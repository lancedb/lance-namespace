...
InsertIntoTableResponse::InsertIntoTableResponse()
{
...
void InsertIntoTableResponse::validate()
{
    // TODO: implement validation
}

web::json::value InsertIntoTableResponse::toJson() const
{
...
bool InsertIntoTableResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InsertIntoTableResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InsertIntoTableResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t InsertIntoTableResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void InsertIntoTableResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool InsertIntoTableResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void InsertIntoTableResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
