...
void DropTableRequest::validate()
{
    // TODO: implement validation
}

web::json::value DropTableRequest::toJson() const
{
...
bool DropTableRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DropTableRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DropTableRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Identity> DropTableRequest::getIdentity() const
{
    return m_Identity;
}


void DropTableRequest::setIdentity(const std::shared_ptr<Identity>& value)
{
    m_Identity = value;
    m_IdentityIsSet = true;
}

bool DropTableRequest::identityIsSet() const
{
    return m_IdentityIsSet;
}

void DropTableRequest::unsetIdentity()
{
    m_IdentityIsSet = false;
}
std::map<utility::string_t, utility::string_t> DropTableRequest::getContext() const
{
    return m_Context;
}


void DropTableRequest::setContext(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Context = value;
    m_ContextIsSet = true;
}

bool DropTableRequest::contextIsSet() const
{
    return m_ContextIsSet;
}

void DropTableRequest::unsetContext()
{
    m_ContextIsSet = false;
}
std::vector<utility::string_t> DropTableRequest::getId() const
{
    return m_Id;
}


void DropTableRequest::setId(const std::vector<utility::string_t>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DropTableRequest::idIsSet() const
{
    return m_IdIsSet;
}

void DropTableRequest::unsetId()
{
    m_IdIsSet = false;
}
