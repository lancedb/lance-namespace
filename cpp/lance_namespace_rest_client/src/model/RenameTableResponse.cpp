...
RenameTableResponse::RenameTableResponse()
{
...
void RenameTableResponse::validate()
{
    // TODO: implement validation
}

web::json::value RenameTableResponse::toJson() const
{
...
bool RenameTableResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RenameTableResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RenameTableResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t RenameTableResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void RenameTableResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool RenameTableResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void RenameTableResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
