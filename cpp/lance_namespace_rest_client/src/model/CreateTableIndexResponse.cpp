...
void CreateTableIndexResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateTableIndexResponse::toJson() const
{
...
bool CreateTableIndexResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTableIndexResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTableIndexResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateTableIndexResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void CreateTableIndexResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool CreateTableIndexResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void CreateTableIndexResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
