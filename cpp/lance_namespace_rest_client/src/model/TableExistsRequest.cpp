...
void TableExistsRequest::validate()
{
    // TODO: implement validation
}

web::json::value TableExistsRequest::toJson() const
{
...
bool TableExistsRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TableExistsRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TableExistsRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Identity> TableExistsRequest::getIdentity() const
{
    return m_Identity;
}


void TableExistsRequest::setIdentity(const std::shared_ptr<Identity>& value)
{
    m_Identity = value;
    m_IdentityIsSet = true;
}

bool TableExistsRequest::identityIsSet() const
{
    return m_IdentityIsSet;
}

void TableExistsRequest::unsetIdentity()
{
    m_IdentityIsSet = false;
}
std::map<utility::string_t, utility::string_t> TableExistsRequest::getContext() const
{
    return m_Context;
}


void TableExistsRequest::setContext(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Context = value;
    m_ContextIsSet = true;
}

bool TableExistsRequest::contextIsSet() const
{
    return m_ContextIsSet;
}

void TableExistsRequest::unsetContext()
{
    m_ContextIsSet = false;
}
std::vector<utility::string_t> TableExistsRequest::getId() const
{
    return m_Id;
}


void TableExistsRequest::setId(const std::vector<utility::string_t>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool TableExistsRequest::idIsSet() const
{
    return m_IdIsSet;
}

void TableExistsRequest::unsetId()
{
    m_IdIsSet = false;
}
int64_t TableExistsRequest::getVersion() const
{
    return m_Version;
}

void TableExistsRequest::setVersion(int64_t value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool TableExistsRequest::versionIsSet() const
{
    return m_VersionIsSet;
}

void TableExistsRequest::unsetVersion()
{
    m_VersionIsSet = false;
}
