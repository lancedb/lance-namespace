...
void CreateTableScalarIndexResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateTableScalarIndexResponse::toJson() const
{
...
bool CreateTableScalarIndexResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTableScalarIndexResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTableScalarIndexResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateTableScalarIndexResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void CreateTableScalarIndexResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool CreateTableScalarIndexResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void CreateTableScalarIndexResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
