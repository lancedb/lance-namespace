...
void DeregisterTableResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeregisterTableResponse::toJson() const
{
...
bool DeregisterTableResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeregisterTableResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeregisterTableResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DeregisterTableResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void DeregisterTableResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool DeregisterTableResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void DeregisterTableResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
std::vector<utility::string_t> DeregisterTableResponse::getId() const
{
    return m_Id;
}


void DeregisterTableResponse::setId(const std::vector<utility::string_t>& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DeregisterTableResponse::idIsSet() const
{
    return m_IdIsSet;
}

void DeregisterTableResponse::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t DeregisterTableResponse::getLocation() const
{
    return m_Location;
}


void DeregisterTableResponse::setLocation(const utility::string_t& value)
{
    m_Location = value;
    m_LocationIsSet = true;
}

bool DeregisterTableResponse::locationIsSet() const
{
    return m_LocationIsSet;
}

void DeregisterTableResponse::unsetLocation()
{
    m_LocationIsSet = false;
}
std::map<utility::string_t, utility::string_t> DeregisterTableResponse::getProperties() const
{
    return m_Properties;
}


void DeregisterTableResponse::setProperties(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Properties = value;
    m_PropertiesIsSet = true;
}

bool DeregisterTableResponse::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void DeregisterTableResponse::unsetProperties()
{
    m_PropertiesIsSet = false;
}
