...
DeleteTableTagResponse::DeleteTableTagResponse()
{
...
void DeleteTableTagResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteTableTagResponse::toJson() const
{
...
bool DeleteTableTagResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteTableTagResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteTableTagResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DeleteTableTagResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void DeleteTableTagResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool DeleteTableTagResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void DeleteTableTagResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
