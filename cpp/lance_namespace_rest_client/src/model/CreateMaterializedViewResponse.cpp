...
void CreateMaterializedViewResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateMaterializedViewResponse::toJson() const
{
...
bool CreateMaterializedViewResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateMaterializedViewResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateMaterializedViewResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int64_t CreateMaterializedViewResponse::getVersion() const
{
    return m_Version;
}

void CreateMaterializedViewResponse::setVersion(int64_t value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CreateMaterializedViewResponse::versionIsSet() const
{
    return m_VersionIsSet;
}

void CreateMaterializedViewResponse::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t CreateMaterializedViewResponse::getJobId() const
{
    return m_Job_id;
}


void CreateMaterializedViewResponse::setJobId(const utility::string_t& value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool CreateMaterializedViewResponse::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void CreateMaterializedViewResponse::unsetJob_id()
{
    m_Job_idIsSet = false;
}
