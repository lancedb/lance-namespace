...
void CreateNamespaceResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateNamespaceResponse::toJson() const
{
...
bool CreateNamespaceResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateNamespaceResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateNamespaceResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateNamespaceResponse::getTransactionId() const
{
    return m_Transaction_id;
}


void CreateNamespaceResponse::setTransactionId(const utility::string_t& value)
{
    m_Transaction_id = value;
    m_Transaction_idIsSet = true;
}

bool CreateNamespaceResponse::transactionIdIsSet() const
{
    return m_Transaction_idIsSet;
}

void CreateNamespaceResponse::unsetTransaction_id()
{
    m_Transaction_idIsSet = false;
}
std::map<utility::string_t, utility::string_t> CreateNamespaceResponse::getProperties() const
{
    return m_Properties;
}


void CreateNamespaceResponse::setProperties(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Properties = value;
    m_PropertiesIsSet = true;
}

bool CreateNamespaceResponse::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void CreateNamespaceResponse::unsetProperties()
{
    m_PropertiesIsSet = false;
}
