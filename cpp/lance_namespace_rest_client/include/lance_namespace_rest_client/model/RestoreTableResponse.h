...
/*
 * RestoreTableResponse.h
 *
 * Response for restore table operation
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_RestoreTableResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_RestoreTableResponse_H_
