...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BatchCommitTablesRequest_H_
...
public:
    ...
    virtual ~BatchCommitTablesRequest();
    ...
    /////////////////////////////////////////////
    /// BatchCommitTablesRequest members
    ...
    /// </summary>
    std::vector<std::shared_ptr<CommitTableOperation>> getOperations() const;
    bool operationsIsSet() const;
    void unsetOperations();
    void setOperations(const std::vector<std::shared_ptr<CommitTableOperation>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CommitTableOperation>> m_Operations;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BatchCommitTablesRequest_H_ */
