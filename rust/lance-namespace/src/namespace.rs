...
pub trait LanceNamespace: Send + Sync {
    ...
    async fn describe_namespace(&self, _request: DescribeNamespaceRequest) -> Result<DescribeNamespaceResponse> {
        Err(NamespaceError::NotSupported("describe_namespace".to_string()))
    }
    ...
    /// Describe a table.
    async fn describe_table(&self, _request: DescribeTableRequest) -> Result<DescribeTableResponse> {
        Err(NamespaceError::NotSupported("describe_table".to_string()))
    }
    
    /// Register a table.
    async fn register_table(&self, _request: RegisterTableRequest) -> Result<RegisterTableResponse> {
    ...
    /// Deregister a table.
    async fn deregister_table(&self, _request: DeregisterTableRequest) -> Result<DeregisterTableResponse> {
    ...
    /// Create a new table.
    async fn create_table(&self, _request: CreateTableRequest, _request_data: Bytes) -> Result<CreateTableResponse> {
        Err(NamespaceError::NotSupported("create_table".to_string()))
    }
    
    /// Insert data into a table.
    async fn insert_into_table(&self, _request: InsertIntoTableRequest, _request_data: Bytes) -> Result<InsertIntoTableResponse> {
        Err(NamespaceError::NotSupported("insert_into_table".to_string()))
    }
    ...
    async fn merge_insert_into_table(
        ...
        Err(NamespaceError::NotSupported("merge_insert_into_table".to_string()))
    }
    ...
    /// Delete from a table.
    async fn delete_from_table(&self, _request: DeleteFromTableRequest) -> Result<DeleteFromTableResponse> {
        Err(NamespaceError::NotSupported("delete_from_table".to_string()))
    }
    ...
    async fn create_table_index(&self, _request: CreateTableIndexRequest) -> Result<CreateTableIndexResponse> {
        Err(NamespaceError::NotSupported("create_table_index".to_string()))
    }
    
    /// List table indices.
    async fn list_table_indices(&self, _request: ListTableIndicesRequest) -> Result<ListTableIndicesResponse> {
        Err(NamespaceError::NotSupported("list_table_indices".to_string()))
    }
    ...
    async fn describe_table_index_stats(
        ...
        Err(NamespaceError::NotSupported("describe_table_index_stats".to_string()))
    }
    
    /// Describe a transaction.
    async fn describe_transaction(&self, _request: DescribeTransactionRequest) -> Result<DescribeTransactionResponse> {
        Err(NamespaceError::NotSupported("describe_transaction".to_string()))
    }
    
    /// Alter a transaction.
    async fn alter_transaction(&self, _request: AlterTransactionRequest) -> Result<AlterTransactionResponse> {
        Err(NamespaceError::NotSupported("alter_transaction".to_string()))
    }
}