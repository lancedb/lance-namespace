...
/// NamespaceExistsResponse : Response for a namespace existence check.  This model is not used by the REST namespace, which conveys existence via the HTTP status code (200 if the namespace exists, 404 otherwise). It is provided as a standard data model for non-REST LanceNamespace interfaces (e.g. Java, Python). 
...
impl NamespaceExistsResponse {
    ...
    pub fn new() -> NamespaceExistsResponse {
