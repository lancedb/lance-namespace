...
pub struct BatchCreateTableVersionsRequest {
    ...
    pub entries: Vec<models::CreateTableVersionEntry>,
}

impl BatchCreateTableVersionsRequest {
    ...
    pub fn new(entries: Vec<models::CreateTableVersionEntry>) -> BatchCreateTableVersionsRequest {
