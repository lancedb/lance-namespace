...
/// BatchDeleteTableVersionsResponse : Response for deleting table version records
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BatchDeleteTableVersionsResponse {
...
impl BatchDeleteTableVersionsResponse {
    /// Response for deleting table version records
    pub fn new() -> BatchDeleteTableVersionsResponse {
