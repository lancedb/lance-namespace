...
pub struct MergeInsertIntoTableRequest {
    ...
    #[serde(
        rename = "when_matched_update_all",
    ...
    #[serde(
        rename = "when_not_matched_by_source_delete_filt",
        skip_serializing_if = "Option::is_none"
    )]
