...
/// ListTableBranchesResponse : Response containing table branches
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ListTableBranchesResponse {
    /// Map of branch names to their contents
    #[serde(rename = "branches")]
    pub branches: std::collections::HashMap<String, models::BranchContents>,
...
impl ListTableBranchesResponse {
    /// Response containing table branches
    pub fn new(branches: std::collections::HashMap<String, models::BranchContents>) -> ListTableBranchesResponse {
