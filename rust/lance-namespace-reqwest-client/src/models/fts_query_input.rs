...
#[serde(untagged)]
pub enum FtsQueryInput {
    StringFtsQuery(Box<models::StringFtsQuery>),
    StructuredFtsQuery(Box<models::StructuredFtsQuery>),
}

impl Default for FtsQueryInput {
    fn default() -> Self {
        Self::StringFtsQuery(Default::default())
    }
}
