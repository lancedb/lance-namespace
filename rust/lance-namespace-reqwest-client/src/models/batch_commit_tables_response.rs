...
pub struct BatchCommitTablesResponse {
    ...
    pub results: Vec<models::CommitTableResult>,
}

impl BatchCommitTablesResponse {
    /// Response for a batch commit of table operations. Contains the results of each operation in the same order as the request. 
    pub fn new(results: Vec<models::CommitTableResult>) -> BatchCommitTablesResponse {
