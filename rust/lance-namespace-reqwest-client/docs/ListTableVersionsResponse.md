...
**versions** | [**Vec<models::TableVersion>**](TableVersion.md) | List of table versions. When `descending=true`, guaranteed to be ordered from latest to oldest. Otherwise, ordering is implementation-defined.  | 
