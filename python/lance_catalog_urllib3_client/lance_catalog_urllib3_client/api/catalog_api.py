...
class CatalogApi:
    ...
    def catalog_exists(
        ...
        catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the catalog identifier")] = None,
        ...
        :type catalog: str
        :param catalog_delimiter: The delimiter used by the catalog identifier
