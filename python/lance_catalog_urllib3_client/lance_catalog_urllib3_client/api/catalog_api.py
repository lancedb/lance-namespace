...
class CatalogApi:
    ...
    def catalog_exists(
        ...
        catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the catalog identifier string")] = None,
        ...
        :type catalog: str
        :param catalog_delimiter: The delimiter used by the catalog identifier string
        :type catalog_delimiter: str
        ...
        _param = self._catalog_exists_serialize(
            catalog=catalog,
            catalog_delimiter=catalog_delimiter,
    ...
    @validate_call
    def catalog_exists_with_http_info(
        self,
        catalog: Annotated[StrictStr, Field(description="An identifier of the catalog.")],
        catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the catalog identifier string")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def catalog_exists_without_preload_content(
        self,
        catalog: Annotated[StrictStr, Field(description="An identifier of the catalog.")],
        catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the catalog identifier string")] = None,
        _request_timeout: Union[
    ...
    def _catalog_exists_serialize(
        ...
        if catalog_delimiter is not None:
            
            _query_params.append(('catalogDelimiter', catalog_delimiter))
        ...
        return self.api_client.param_serialize(
            method='HEAD',
            resource_path='/v1/catalogs/{catalog}',
    ...
    def create_catalog(
        ...
        parent_catalog: Annotated[Optional[StrictStr], Field(description="An identifier of the parent catalog.")] = None,
        parent_catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the parent catalog identifier")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param parent_catalog: An identifier of the parent catalog.
        :type parent_catalog: str
        :param parent_catalog_delimiter: The delimiter used by the parent catalog identifier
        :type parent_catalog_delimiter: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_catalog_serialize(
            ...
            parent_catalog_delimiter=parent_catalog_delimiter,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_catalog_serialize(
        ...
        if parent_catalog is not None:
            ...
            _query_params.append(('parentCatalog', parent_catalog))
            
        if parent_catalog_delimiter is not None:
            
            _query_params.append(('parentCatalogDelimiter', parent_catalog_delimiter))
    ...
    def drop_catalog(
        ...
        _param = self._drop_catalog_serialize(
            catalog=catalog,
            catalog_delimiter=catalog_delimiter,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def drop_catalog_with_http_info(
        self,
        catalog: Annotated[StrictStr, Field(description="An identifier of the catalog.")],
        catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the catalog identifier string")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def drop_catalog_without_preload_content(
        self,
        catalog: Annotated[StrictStr, Field(description="An identifier of the catalog.")],
        catalog_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the catalog identifier string")] = None,
        _request_timeout: Union[
    ...
    def get_catalog_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCatalogResponse]:
        """Get information about a catalog
