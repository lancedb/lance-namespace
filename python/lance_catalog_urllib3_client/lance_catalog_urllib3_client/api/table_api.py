...
class TableApi:
    ...
    def get_table(
        self,
        table: Annotated[StrictStr, Field(description="An identifier of the table")],
        table_delimiter: Annotated[Optional[StrictStr], Field(description="The delimiter used by the table identifier")] = None,
        ...
        :type table: str
        :param table_delimiter: The delimiter used by the table identifier
    ...
    def _get_table_serialize(
        ...
        if table_delimiter is not None:
            ...
            _query_params.append(('tableDelimiter', table_delimiter))
    ...
    def _register_table_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/catalogs/{catalog}/register',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
