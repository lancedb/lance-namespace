...
class AnalyzeTableQueryPlanRequest(BaseModel):
    ...
    filter: Optional[StrictStr] = Field(default=None, description="Optional SQL filter expression. Field references in the expression must use Lance field path syntax. ")
