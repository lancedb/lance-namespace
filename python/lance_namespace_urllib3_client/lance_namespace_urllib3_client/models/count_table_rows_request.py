...
class CountTableRowsRequest(BaseModel):
    ...
    predicate: Optional[StrictStr] = Field(default=None, description="Optional SQL predicate to filter rows for counting. Field references must use Lance field path syntax. ")
