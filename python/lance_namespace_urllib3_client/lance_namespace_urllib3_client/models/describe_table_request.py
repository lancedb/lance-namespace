...
class DescribeTableRequest(BaseModel):
    ...
    tag: Optional[StrictStr] = Field(default=None, description="Tag name to describe the table at. If specified, the server should resolve the tag to a version number and describe that version. Cannot be used together with `version` or `branch`. ")
    ...
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "version", "tag", "branch", "with_table_uri", "load_detailed_metadata", "check_declared", "vend_credentials"]
