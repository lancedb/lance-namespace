...
class CountTableRowsResponse(BaseModel):
    """
    ...
    count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The count of rows.")
    __properties: ClassVar[List[str]] = ["context", "count"]
