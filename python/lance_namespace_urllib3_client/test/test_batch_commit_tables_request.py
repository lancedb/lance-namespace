...
class TestBatchCommitTablesRequest(unittest.TestCase):
    """BatchCommitTablesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCommitTablesRequest:
        """Test BatchCommitTablesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCommitTablesRequest`
        """
        model = BatchCommitTablesRequest()
        if include_optional:
    ...
    def testBatchCommitTablesRequest(self):
        """Test BatchCommitTablesRequest"""
