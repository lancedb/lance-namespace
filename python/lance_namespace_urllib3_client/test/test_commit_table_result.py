...
class TestCommitTableResult(unittest.TestCase):
    """CommitTableResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommitTableResult:
        """Test CommitTableResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitTableResult`
        """
        model = CommitTableResult()
        if include_optional:
    ...
    def testCommitTableResult(self):
        """Test CommitTableResult"""
