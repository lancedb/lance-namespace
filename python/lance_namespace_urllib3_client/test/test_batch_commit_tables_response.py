...
class TestBatchCommitTablesResponse(unittest.TestCase):
    """BatchCommitTablesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCommitTablesResponse:
        """Test BatchCommitTablesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCommitTablesResponse`
        """
    ...
    def testBatchCommitTablesResponse(self):
        """Test BatchCommitTablesResponse"""
