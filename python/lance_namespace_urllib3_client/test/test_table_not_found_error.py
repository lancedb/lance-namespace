...
class TestTableNotFoundError(unittest.TestCase):
    """TableNotFoundError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableNotFoundError:
        """Test TableNotFoundError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableNotFoundError`
        """
        model = TableNotFoundError()
        if include_optional:
