...
class TestFtsQueryInput(unittest.TestCase):
    """FtsQueryInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FtsQueryInput:
        """Test FtsQueryInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FtsQueryInput`
        """
        model = FtsQueryInput()
        if include_optional:
            return FtsQueryInput(
                columns = [
                    ''
                    ],
                query = None
