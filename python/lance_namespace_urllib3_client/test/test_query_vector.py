...
class TestQueryVector(unittest.TestCase):
    """QueryVector unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryVector:
        """Test QueryVector
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryVector`
        """
        model = QueryVector()
        if include_optional:
            return QueryVector(
