# lance_namespace_urllib3_client.BranchApi
...
with lance_namespace_urllib3_client.ApiClient(configuration) as api_client:
    ...
    api_instance = lance_namespace_urllib3_client.BranchApi(api_client)
    ...
    try:
        ...
        print("The response of BranchApi->create_table_branch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchApi->create_table_branch: %s\n" % e)
```
...
with lance_namespace_urllib3_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BranchApi->delete_table_branch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchApi->delete_table_branch: %s\n" % e)
```
...
with lance_namespace_urllib3_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BranchApi->list_table_branches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchApi->list_table_branches: %s\n" % e)
```
