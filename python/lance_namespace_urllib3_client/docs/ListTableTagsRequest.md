...
list_table_tags_request_instance = ListTableTagsRequest.from_json(json)
# print the JSON string representation of the object
print(ListTableTagsRequest.to_json())

# convert the object into a dict
list_table_tags_request_dict = list_table_tags_request_instance.to_dict()
# create an instance of ListTableTagsRequest from a dict
list_table_tags_request_from_dict = ListTableTagsRequest.from_dict(list_table_tags_request_dict)
```
