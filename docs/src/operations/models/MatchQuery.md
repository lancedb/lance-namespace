...
|**operator** | **String** | The operator to use for combining terms. Case insensitive. Valid values are: - And: All terms must match. - Or: At least one term must match.  |  [optional] |
