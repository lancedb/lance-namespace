...
@JsonPropertyOrder({
  TableSchemaMismatchError.JSON_PROPERTY_ERROR,
  TableSchemaMismatchError.JSON_PROPERTY_CODE,
  TableSchemaMismatchError.JSON_PROPERTY_TYPE,
  TableSchemaMismatchError.JSON_PROPERTY_DETAIL,
  TableSchemaMismatchError.JSON_PROPERTY_INSTANCE
})
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class TableSchemaMismatchError {
  ...
  public TableSchemaMismatchError() {}

  public TableSchemaMismatchError error(@javax.annotation.Nonnull String error) {
  ...
  public TableSchemaMismatchError code(@javax.annotation.Nonnull CodeEnum code) {
  ...
  public TableSchemaMismatchError type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public TableSchemaMismatchError detail(@javax.annotation.Nullable String detail) {
  ...
  public TableSchemaMismatchError instance(@javax.annotation.Nullable String instance) {
  ...
  public boolean equals(Object o) {
    ...
    TableSchemaMismatchError tableSchemaMismatchError = (TableSchemaMismatchError) o;
    return Objects.equals(this.error, tableSchemaMismatchError.error)
        && Objects.equals(this.code, tableSchemaMismatchError.code)
        && Objects.equals(this.type, tableSchemaMismatchError.type)
        && Objects.equals(this.detail, tableSchemaMismatchError.detail)
        && Objects.equals(this.instance, tableSchemaMismatchError.instance);
  }
  ...
  public String toString() {
    ...
    sb.append("class TableSchemaMismatchError {\n");
