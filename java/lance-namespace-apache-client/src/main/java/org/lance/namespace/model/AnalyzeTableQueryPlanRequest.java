...
public class AnalyzeTableQueryPlanRequest {
  ...
  public AnalyzeTableQueryPlanRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public AnalyzeTableQueryPlanRequest bypassVectorIndex(@javax.annotation.Nullable Boolean bypassVectorIndex) {
  ...
  public AnalyzeTableQueryPlanRequest columns(@javax.annotation.Nullable QueryTableRequestColumns columns) {
  ...
  public AnalyzeTableQueryPlanRequest fullTextQuery(@javax.annotation.Nullable QueryTableRequestFullTextQuery fullTextQuery) {
  ...
  @JsonProperty(JSON_PROPERTY_FULL_TEXT_QUERY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFullTextQuery(@javax.annotation.Nullable QueryTableRequestFullTextQuery fullTextQuery) {
    this.fullTextQuery = fullTextQuery;
  }
  ...
  public AnalyzeTableQueryPlanRequest refineFactor(@javax.annotation.Nullable Integer refineFactor) {
  ...
  public AnalyzeTableQueryPlanRequest vector(@javax.annotation.Nonnull QueryTableRequestVector vector) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBypassVectorIndex() != null) {
      try {
        joiner.add(String.format("%sbypass_vector_index%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBypassVectorIndex()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getDistanceType() != null) {
      try {
        joiner.add(String.format("%sdistance_type%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDistanceType()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getEf() != null) {
      try {
        joiner.add(String.format("%sef%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEf()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getFastSearch() != null) {
      try {
        joiner.add(String.format("%sfast_search%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFastSearch()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getFilter() != null) {
      try {
        joiner.add(String.format("%sfilter%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFilter()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getLowerBound() != null) {
      try {
        joiner.add(String.format("%slower_bound%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLowerBound()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getNprobes() != null) {
      try {
        joiner.add(String.format("%snprobes%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNprobes()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getPrefilter() != null) {
      try {
        joiner.add(String.format("%sprefilter%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPrefilter()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getRefineFactor() != null) {
      try {
        joiner.add(String.format("%srefine_factor%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getRefineFactor()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUpperBound() != null) {
      try {
        joiner.add(String.format("%supper_bound%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUpperBound()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getVectorColumn() != null) {
      try {
        joiner.add(String.format("%svector_column%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVectorColumn()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getWithRowId() != null) {
      try {
        joiner.add(String.format("%swith_row_id%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getWithRowId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
