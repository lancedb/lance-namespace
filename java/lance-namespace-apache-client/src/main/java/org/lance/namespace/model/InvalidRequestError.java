...
@JsonPropertyOrder({
  InvalidRequestError.JSON_PROPERTY_ERROR,
  InvalidRequestError.JSON_PROPERTY_CODE,
  InvalidRequestError.JSON_PROPERTY_TYPE,
  InvalidRequestError.JSON_PROPERTY_DETAIL,
  InvalidRequestError.JSON_PROPERTY_INSTANCE
})
...
public class InvalidRequestError {
  ...
  public InvalidRequestError error(@javax.annotation.Nonnull String error) {
  ...
  public InvalidRequestError code(@javax.annotation.Nonnull CodeEnum code) {
  ...
  public InvalidRequestError type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public InvalidRequestError detail(@javax.annotation.Nullable String detail) {
  ...
  public InvalidRequestError instance(@javax.annotation.Nullable String instance) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, invalidRequestError.error)
        && Objects.equals(this.code, invalidRequestError.code)
        && Objects.equals(this.type, invalidRequestError.type)
        && Objects.equals(this.detail, invalidRequestError.detail)
        && Objects.equals(this.instance, invalidRequestError.instance);
  }
