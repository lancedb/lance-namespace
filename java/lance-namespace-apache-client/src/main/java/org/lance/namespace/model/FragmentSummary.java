...
public class FragmentSummary {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMean() != null) {
      try {
        joiner.add(String.format("%smean%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMean()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getP25() != null) {
      try {
        joiner.add(String.format("%sp25%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getP25()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getP50() != null) {
      try {
        joiner.add(String.format("%sp50%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getP50()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getP75() != null) {
      try {
        joiner.add(String.format("%sp75%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getP75()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getP99() != null) {
      try {
        joiner.add(String.format("%sp99%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getP99()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
