...
public class ListTableVersionsRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPageToken() != null) {
      try {
        joiner.add(String.format("%spage_token%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPageToken()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getDescending() != null) {
      try {
        joiner.add(String.format("%sdescending%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDescending()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
