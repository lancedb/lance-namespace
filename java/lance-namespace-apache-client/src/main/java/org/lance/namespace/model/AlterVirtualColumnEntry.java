...
public class AlterVirtualColumnEntry {
  ...
  public AlterVirtualColumnEntry inputColumns(@javax.annotation.Nullable List<String> inputColumns) {
  ...
  public AlterVirtualColumnEntry manifestChecksum(@javax.annotation.Nullable String manifestChecksum) {
  ...
  public AlterVirtualColumnEntry fieldMetadata(@javax.annotation.Nullable Map<String, String> fieldMetadata) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(inputColumns), hashCodeNullable(image), hashCodeNullable(udf), hashCodeNullable(udfName), hashCodeNullable(udfVersion), hashCodeNullable(udfBackend), hashCodeNullable(autoBackfill), hashCodeNullable(manifest), hashCodeNullable(manifestChecksum), fieldMetadata);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUdf() != null) {
      try {
        joiner.add(String.format("%sudf%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUdf()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUdfName() != null) {
      try {
        joiner.add(String.format("%sudf_name%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUdfName()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUdfVersion() != null) {
      try {
        joiner.add(String.format("%sudf_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUdfVersion()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUdfBackend() != null) {
      try {
        joiner.add(String.format("%sudf_backend%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUdfBackend()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAutoBackfill() != null) {
      try {
        joiner.add(String.format("%sauto_backfill%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAutoBackfill()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getFieldMetadata() != null) {
      for (String _key : getFieldMetadata().keySet()) {
        try {
          joiner.add(String.format("%sfield_metadata%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, _key, containerSuffix),
              getFieldMetadata().get(_key), URLEncoder.encode(String.valueOf(getFieldMetadata().get(_key)), "UTF-8").replaceAll("\\+", "%20")));
        } catch (UnsupportedEncodingException e) {
          // Should never happen, UTF-8 is always supported
          throw new RuntimeException(e);
        }
