...
public class CommitTableOperation {
  ...
  public CommitTableOperation declareTable(@javax.annotation.Nullable DeclareTableRequest declareTable) {
  ...
  public CommitTableOperation createTableVersion(@javax.annotation.Nullable CreateTableVersionRequest createTableVersion) {
  ...
  @JsonProperty(JSON_PROPERTY_CREATE_TABLE_VERSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCreateTableVersion(@javax.annotation.Nullable CreateTableVersionRequest createTableVersion) {
    this.createTableVersion = createTableVersion;
  }

  public CommitTableOperation deleteTableVersions(@javax.annotation.Nullable BatchDeleteTableVersionsRequest deleteTableVersions) {
  ...
  @JsonProperty(JSON_PROPERTY_DELETE_TABLE_VERSIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeleteTableVersions(@javax.annotation.Nullable BatchDeleteTableVersionsRequest deleteTableVersions) {
    this.deleteTableVersions = deleteTableVersions;
  }

  public CommitTableOperation deregisterTable(@javax.annotation.Nullable DeregisterTableRequest deregisterTable) {
  ...
  @JsonProperty(JSON_PROPERTY_DEREGISTER_TABLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeregisterTable(@javax.annotation.Nullable DeregisterTableRequest deregisterTable) {
    this.deregisterTable = deregisterTable;
  }
