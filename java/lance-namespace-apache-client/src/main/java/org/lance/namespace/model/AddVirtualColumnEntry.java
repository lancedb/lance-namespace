...
public class AddVirtualColumnEntry {
  ...
  public AddVirtualColumnEntry manifestChecksum(@javax.annotation.Nullable String manifestChecksum) {
  ...
  public AddVirtualColumnEntry fieldMetadata(@javax.annotation.Nullable Map<String, String> fieldMetadata) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inputColumns, dataType, image, udf, udfName, udfVersion, hashCodeNullable(udfBackend), hashCodeNullable(autoBackfill), hashCodeNullable(manifest), hashCodeNullable(manifestChecksum), fieldMetadata);
  }
