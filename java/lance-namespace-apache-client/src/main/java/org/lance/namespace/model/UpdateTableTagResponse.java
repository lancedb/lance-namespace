...
@JsonPropertyOrder({
  UpdateTableTagResponse.JSON_PROPERTY_CONTEXT,
  UpdateTableTagResponse.JSON_PROPERTY_TRANSACTION_ID
})
...
public class UpdateTableTagResponse {
  ...
  public UpdateTableTagResponse() {}

  public UpdateTableTagResponse context(@javax.annotation.Nullable Map<String, String> context) {

    this.context = context;
    return this;
  }

  public UpdateTableTagResponse putContextItem(String key, String contextItem) {
  ...
  public UpdateTableTagResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, updateTableTagResponse.context)
        && Objects.equals(this.transactionId, updateTableTagResponse.transactionId);
  }
