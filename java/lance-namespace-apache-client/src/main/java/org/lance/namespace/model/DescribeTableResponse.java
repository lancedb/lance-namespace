...
import org.lance.namespace.model.TableBasicStats;
...
public class DescribeTableResponse {
  ...
  public DescribeTableResponse storageOptions(@javax.annotation.Nullable Map<String, String> storageOptions) {
  ...
  public DescribeTableResponse properties(@javax.annotation.Nullable Map<String, String> properties) {
  ...
  public DescribeTableResponse managedVersioning(@javax.annotation.Nullable Boolean managedVersioning) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTable() != null) {
      try {
        joiner.add(String.format("%stable%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTable()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getTableUri() != null) {
      try {
        joiner.add(String.format("%stable_uri%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTableUri()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getStorageOptions() != null) {
      for (String _key : getStorageOptions().keySet()) {
        try {
          joiner.add(String.format("%sstorage_options%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, _key, containerSuffix),
              getStorageOptions().get(_key), URLEncoder.encode(String.valueOf(getStorageOptions().get(_key)), "UTF-8").replaceAll("\\+", "%20")));
        } catch (UnsupportedEncodingException e) {
          // Should never happen, UTF-8 is always supported
          throw new RuntimeException(e);
        }
    ...
    if (getManagedVersioning() != null) {
      try {
        joiner.add(String.format("%smanaged_versioning%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getManagedVersioning()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIsOnlyDeclared() != null) {
      try {
        joiner.add(String.format("%sis_only_declared%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsOnlyDeclared()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
