...
@JsonPropertyOrder({
  TransactionNotFoundError.JSON_PROPERTY_ERROR,
  TransactionNotFoundError.JSON_PROPERTY_CODE,
  TransactionNotFoundError.JSON_PROPERTY_TYPE,
  TransactionNotFoundError.JSON_PROPERTY_DETAIL,
  TransactionNotFoundError.JSON_PROPERTY_INSTANCE
})
...
public class TransactionNotFoundError {
  ...
  public enum TypeEnum {
    LANCE_NAMESPACE_501(String.valueOf("lance-namespace:501"));
  ...
  public TransactionNotFoundError error(@javax.annotation.Nonnull String error) {
  ...
  public TransactionNotFoundError code(@javax.annotation.Nonnull CodeEnum code) {
  ...
  public TransactionNotFoundError type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public TransactionNotFoundError detail(@javax.annotation.Nullable String detail) {
  ...
  public TransactionNotFoundError instance(@javax.annotation.Nullable String instance) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, transactionNotFoundError.error)
        && Objects.equals(this.code, transactionNotFoundError.code)
        && Objects.equals(this.type, transactionNotFoundError.type)
        && Objects.equals(this.detail, transactionNotFoundError.detail)
        && Objects.equals(this.instance, transactionNotFoundError.instance);
  }
