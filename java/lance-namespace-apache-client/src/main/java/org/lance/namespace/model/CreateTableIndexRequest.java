...
public class CreateTableIndexRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIndexType() != null) {
      try {
        joiner.add(String.format("%sindex_type%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIndexType()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getWithPosition() != null) {
      try {
        joiner.add(String.format("%swith_position%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getWithPosition()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getBaseTokenizer() != null) {
      try {
        joiner.add(String.format("%sbase_tokenizer%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBaseTokenizer()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getMaxTokenLength() != null) {
      try {
        joiner.add(String.format("%smax_token_length%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMaxTokenLength()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getLowerCase() != null) {
      try {
        joiner.add(String.format("%slower_case%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLowerCase()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getStem() != null) {
      try {
        joiner.add(String.format("%sstem%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getStem()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getRemoveStopWords() != null) {
      try {
        joiner.add(String.format("%sremove_stop_words%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getRemoveStopWords()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAsciiFolding() != null) {
      try {
        joiner.add(String.format("%sascii_folding%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAsciiFolding()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
