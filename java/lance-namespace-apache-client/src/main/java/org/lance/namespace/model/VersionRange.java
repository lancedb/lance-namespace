...
public class VersionRange {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getStartVersion() != null) {
      try {
        joiner.add(String.format("%sstart_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getStartVersion()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getEndVersion() != null) {
      try {
        joiner.add(String.format("%send_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEndVersion()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
