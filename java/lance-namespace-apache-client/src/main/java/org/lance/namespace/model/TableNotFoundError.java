...
@JsonPropertyOrder({
  TableNotFoundError.JSON_PROPERTY_ERROR,
  TableNotFoundError.JSON_PROPERTY_CODE,
  TableNotFoundError.JSON_PROPERTY_TYPE,
  TableNotFoundError.JSON_PROPERTY_DETAIL,
  TableNotFoundError.JSON_PROPERTY_INSTANCE
})
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class TableNotFoundError {
  ...
  public TableNotFoundError() {}

  public TableNotFoundError error(@javax.annotation.Nonnull String error) {
  ...
  public TableNotFoundError code(@javax.annotation.Nonnull CodeEnum code) {
  ...
  public TableNotFoundError type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public TableNotFoundError detail(@javax.annotation.Nullable String detail) {
  ...
  public TableNotFoundError instance(@javax.annotation.Nullable String instance) {
  ...
  public boolean equals(Object o) {
    ...
    TableNotFoundError tableNotFoundError = (TableNotFoundError) o;
    return Objects.equals(this.error, tableNotFoundError.error)
        && Objects.equals(this.code, tableNotFoundError.code)
        && Objects.equals(this.type, tableNotFoundError.type)
        && Objects.equals(this.detail, tableNotFoundError.detail)
        && Objects.equals(this.instance, tableNotFoundError.instance);
  }
  ...
  public String toString() {
    ...
    sb.append("class TableNotFoundError {\n");
