...
public class GetTableStatsResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTotalBytes() != null) {
      try {
        joiner.add(String.format("%stotal_bytes%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTotalBytes()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getNumRows() != null) {
      try {
        joiner.add(String.format("%snum_rows%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNumRows()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
