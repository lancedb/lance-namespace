...
@JsonPropertyOrder({
  UnknownError.JSON_PROPERTY_ERROR,
  UnknownError.JSON_PROPERTY_CODE,
  UnknownError.JSON_PROPERTY_TYPE,
  UnknownError.JSON_PROPERTY_DETAIL,
  UnknownError.JSON_PROPERTY_INSTANCE
})
...
public class UnknownError {
  ...
  public enum TypeEnum {
    LANCE_NAMESPACE_0(String.valueOf("lance-namespace:0"));
  ...
  public UnknownError error(@javax.annotation.Nonnull String error) {
  ...
  public UnknownError code(@javax.annotation.Nonnull CodeEnum code) {
  ...
  public UnknownError type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public UnknownError detail(@javax.annotation.Nullable String detail) {
  ...
  public UnknownError instance(@javax.annotation.Nullable String instance) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, unknownError.error)
        && Objects.equals(this.code, unknownError.code)
        && Objects.equals(this.type, unknownError.type)
        && Objects.equals(this.detail, unknownError.detail)
        && Objects.equals(this.instance, unknownError.instance);
  }
