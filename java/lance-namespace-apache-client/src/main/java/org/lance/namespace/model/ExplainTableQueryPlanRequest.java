...
public class ExplainTableQueryPlanRequest {
  ...
  public ExplainTableQueryPlanRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVerbose() != null) {
      try {
        joiner.add(String.format("%sverbose%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVerbose()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
