...
public class MatchQuery {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBoost() != null) {
      try {
        joiner.add(String.format("%sboost%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBoost()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getFuzziness() != null) {
      try {
        joiner.add(String.format("%sfuzziness%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFuzziness()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getMaxExpansions() != null) {
      try {
        joiner.add(String.format("%smax_expansions%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMaxExpansions()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getPrefixLength() != null) {
      try {
        joiner.add(String.format("%sprefix_length%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPrefixLength()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTerms() != null) {
      try {
        joiner.add(String.format("%sterms%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTerms()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
