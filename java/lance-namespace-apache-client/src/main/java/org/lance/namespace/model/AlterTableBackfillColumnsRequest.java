...
@JsonPropertyOrder({
  ...
  AlterTableBackfillColumnsRequest.JSON_PROPERTY_CONTEXT,
...
public class AlterTableBackfillColumnsRequest {
  ...
  @javax.annotation.Nullable private JsonNullable<String> where = JsonNullable.<String>undefined();
  ...
  public AlterTableBackfillColumnsRequest context(
  ...
  public AlterTableBackfillColumnsRequest putContextItem(String key, String contextItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, alterTableBackfillColumnsRequest.identity)
        && Objects.equals(this.context, alterTableBackfillColumnsRequest.context)
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getWhere()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getMinCheckpointSize()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getMaxCheckpointSize()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getBatchCheckpointFlushIntervalSeconds()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getReadVersion()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getTaskSize()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getNumFrags()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getCheckpointSize()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getCommitGranularity()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
