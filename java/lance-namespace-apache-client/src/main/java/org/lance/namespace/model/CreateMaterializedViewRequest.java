      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getSourceQuery()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getOutputSchema()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getWithNoData()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getAutoRefresh()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
