...
import org.lance.namespace.model.MaterializedViewUdtfEntry;
...
public class CreateMaterializedViewRequest {
  ...
  @javax.annotation.Nullable
  private JsonNullable<MaterializedViewUdtfEntry> udtfSpec = JsonNullable.<MaterializedViewUdtfEntry>undefined();
  ...
  public CreateMaterializedViewRequest udtfSpec(@javax.annotation.Nullable MaterializedViewUdtfEntry udtfSpec) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identity, id, kind, sourceQuery, outputSchema, hashCodeNullable(udtfSpec), withNoData, hashCodeNullable(autoRefresh));
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSourceQuery() != null) {
      try {
        joiner.add(String.format("%ssource_query%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSourceQuery()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getOutputSchema() != null) {
      try {
        joiner.add(String.format("%soutput_schema%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getOutputSchema()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getWithNoData() != null) {
      try {
        joiner.add(String.format("%swith_no_data%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getWithNoData()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAutoRefresh() != null) {
      try {
        joiner.add(String.format("%sauto_refresh%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAutoRefresh()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
