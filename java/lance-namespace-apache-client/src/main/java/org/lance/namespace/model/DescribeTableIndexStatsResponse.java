...
public class DescribeTableIndexStatsResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNumIndexedRows() != null) {
      try {
        joiner.add(String.format("%snum_indexed_rows%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNumIndexedRows()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getNumUnindexedRows() != null) {
      try {
        joiner.add(String.format("%snum_unindexed_rows%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNumUnindexedRows()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getNumIndices() != null) {
      try {
        joiner.add(String.format("%snum_indices%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNumIndices()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
