...
public class DescribeTableRequest {
  ...
  public DescribeTableRequest loadDetailedMetadata(@javax.annotation.Nullable Boolean loadDetailedMetadata) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWithTableUri() != null) {
      try {
        joiner.add(String.format("%swith_table_uri%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getWithTableUri()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getLoadDetailedMetadata() != null) {
      try {
        joiner.add(String.format("%sload_detailed_metadata%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLoadDetailedMetadata()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCheckDeclared() != null) {
      try {
        joiner.add(String.format("%scheck_declared%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCheckDeclared()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getVendCredentials() != null) {
      try {
        joiner.add(String.format("%svend_credentials%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVendCredentials()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
