...
import com.lancedb.lance.namespace.model.TableBasicStats;
...
public class DescribeTableResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, namespace, location, properties, schema, stats, table, hashCodeNullable(tableUri), version);
  }
