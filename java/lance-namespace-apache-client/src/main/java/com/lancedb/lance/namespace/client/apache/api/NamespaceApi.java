...
public class NamespaceApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListNamespacesResponse listNamespaces(String id, ListNamespacesRequest listNamespacesRequest, String delimiter) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListNamespacesResponse listNamespaces(String id, ListNamespacesRequest listNamespacesRequest, String delimiter, Map<String, String> additionalHeaders) throws ApiException {
    ...
    if (listNamespacesRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'listNamespacesRequest' when calling listNamespaces");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public NamespaceExistsResponse namespaceExists(String id, NamespaceExistsRequest namespaceExistsRequest, String delimiter) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NamespaceExistsResponse namespaceExists(String id, NamespaceExistsRequest namespaceExistsRequest, String delimiter, Map<String, String> additionalHeaders) throws ApiException {
    ...
    TypeReference<NamespaceExistsResponse> localVarReturnType = new TypeReference<NamespaceExistsResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "POST",
        localVarQueryParams,
