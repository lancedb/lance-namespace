...
public class NamespaceNotFoundException extends LanceNamespaceException {
  public NamespaceNotFoundException(String message) {
    super(ErrorCode.NAMESPACE_NOT_FOUND, message);
  }

  public NamespaceNotFoundException(String message, Throwable cause) {
    super(ErrorCode.NAMESPACE_NOT_FOUND, message, cause);
  }

  public NamespaceNotFoundException(
      String message, @Nullable String detail, @Nullable String instance) {
    super(ErrorCode.NAMESPACE_NOT_FOUND, message, detail, instance);
  }
}
