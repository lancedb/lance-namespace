...
| [**createMaterializedView**](TableApi.md#createMaterializedView) | **POST** /v1/table/{id}/create_materialized_view | Create a materialized view |
| [**createMaterializedViewWithHttpInfo**](TableApi.md#createMaterializedViewWithHttpInfo) | **POST** /v1/table/{id}/create_materialized_view | Create a materialized view |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling TableApi#createMaterializedView");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
