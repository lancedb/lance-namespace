...
| [**alterTableBackfillColumnsWithHttpInfo**](DataApi.md#alterTableBackfillColumnsWithHttpInfo) | **POST** /v1/table/{id}/backfill_column | Trigger an async column backfill job |
