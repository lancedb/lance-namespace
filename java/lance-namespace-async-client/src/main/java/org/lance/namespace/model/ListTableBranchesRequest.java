...
@JsonPropertyOrder({
  ListTableBranchesRequest.JSON_PROPERTY_IDENTITY,
  ListTableBranchesRequest.JSON_PROPERTY_CONTEXT,
  ListTableBranchesRequest.JSON_PROPERTY_ID,
  ListTableBranchesRequest.JSON_PROPERTY_PAGE_TOKEN,
  ListTableBranchesRequest.JSON_PROPERTY_LIMIT
})
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class ListTableBranchesRequest {
  ...
  public ListTableBranchesRequest() {}

  public ListTableBranchesRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public ListTableBranchesRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public ListTableBranchesRequest putContextItem(String key, String contextItem) {
  ...
  public ListTableBranchesRequest id(@javax.annotation.Nullable List<String> id) {
    this.id = id;
    return this;
  }

  public ListTableBranchesRequest addIdItem(String idItem) {
    if (this.id == null) {
  ...
  public ListTableBranchesRequest pageToken(@javax.annotation.Nullable String pageToken) {
  ...
  public ListTableBranchesRequest limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  /** Return true if this ListTableBranchesRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ListTableBranchesRequest listTableBranchesRequest = (ListTableBranchesRequest) o;
    return Objects.equals(this.identity, listTableBranchesRequest.identity)
        && Objects.equals(this.context, listTableBranchesRequest.context)
        && Objects.equals(this.id, listTableBranchesRequest.id)
        && Objects.equals(this.pageToken, listTableBranchesRequest.pageToken)
        && Objects.equals(this.limit, listTableBranchesRequest.limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListTableBranchesRequest {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLimit() != null) {
      joiner.add(
          String.format(
              "%slimit%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLimit()))));
    }
