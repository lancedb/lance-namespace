...
@JsonPropertyOrder({
  DeleteTableBranchResponse.JSON_PROPERTY_CONTEXT,
  DeleteTableBranchResponse.JSON_PROPERTY_TRANSACTION_ID
})
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class DeleteTableBranchResponse {
  ...
  public DeleteTableBranchResponse() {}

  public DeleteTableBranchResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DeleteTableBranchResponse putContextItem(String key, String contextItem) {
  ...
  public DeleteTableBranchResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  /** Return true if this DeleteTableBranchResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    DeleteTableBranchResponse deleteTableBranchResponse = (DeleteTableBranchResponse) o;
    return Objects.equals(this.context, deleteTableBranchResponse.context)
        && Objects.equals(this.transactionId, deleteTableBranchResponse.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTableBranchResponse {\n");
