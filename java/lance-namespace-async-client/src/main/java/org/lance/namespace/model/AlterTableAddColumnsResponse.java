...
@JsonPropertyOrder({
  AlterTableAddColumnsResponse.JSON_PROPERTY_CONTEXT,
...
public class AlterTableAddColumnsResponse {
  ...
  public AlterTableAddColumnsResponse context(
      @javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public AlterTableAddColumnsResponse putContextItem(String key, String contextItem) {
  ...
  /** Return true if this AlterTableAddColumnsResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, alterTableAddColumnsResponse.context)
