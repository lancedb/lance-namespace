...
public class CreateMaterializedViewRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSourceQuery() != null) {
      joiner.add(String.format("%ssource_query%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSourceQuery()))));
    }

    // add `output_schema` to the URL query string
    if (getOutputSchema() != null) {
      joiner.add(String.format("%soutput_schema%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOutputSchema()))));
    }
    ...
    if (getWithNoData() != null) {
      joiner.add(String.format("%swith_no_data%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWithNoData()))));
    }

    // add `auto_refresh` to the URL query string
    if (getAutoRefresh() != null) {
      joiner.add(String.format("%sauto_refresh%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAutoRefresh()))));
    }
