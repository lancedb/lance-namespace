...
@JsonPropertyOrder({
  DeregisterTableRequest.JSON_PROPERTY_IDENTITY,
  DeregisterTableRequest.JSON_PROPERTY_CONTEXT,
  DeregisterTableRequest.JSON_PROPERTY_ID
})
...
public class DeregisterTableRequest {
  ...
  public DeregisterTableRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DeregisterTableRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  /** Return true if this DeregisterTableRequest object is equal to o. */
  @Override
