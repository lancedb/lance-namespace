...
public class DescribeTableResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTable() != null) {
      joiner.add(String.format("%stable%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTable()))));
    }
    ...
    if (getTableUri() != null) {
      joiner.add(String.format("%stable_uri%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTableUri()))));
    }
    ...
    if (getStorageOptions() != null) {
      for (String _key : getStorageOptions().keySet()) {
        joiner.add(String.format("%sstorage_options%s%s=%s", prefix, suffix,
            ...
            getStorageOptions().get(_key), ApiClient.urlEncode(ApiClient.valueToString(getStorageOptions().get(_key)))));
      }
    }
    ...
    if (getManagedVersioning() != null) {
      joiner.add(String.format("%smanaged_versioning%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getManagedVersioning()))));
    }

    // add `is_only_declared` to the URL query string
    if (getIsOnlyDeclared() != null) {
      joiner.add(String.format("%sis_only_declared%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsOnlyDeclared()))));
    }
