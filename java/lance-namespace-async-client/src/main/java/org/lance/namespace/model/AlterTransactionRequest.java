 ...
 */
@JsonPropertyOrder({
  AlterTransactionRequest.JSON_PROPERTY_IDENTITY,
  AlterTransactionRequest.JSON_PROPERTY_CONTEXT,
...
public class AlterTransactionRequest {
  ...
  public AlterTransactionRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public AlterTransactionRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  /** Return true if this AlterTransactionRequest object is equal to o. */
  @Override
