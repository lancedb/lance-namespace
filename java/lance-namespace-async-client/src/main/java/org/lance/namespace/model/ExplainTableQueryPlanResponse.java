...
@JsonPropertyOrder({
  ExplainTableQueryPlanResponse.JSON_PROPERTY_CONTEXT,
...
public class ExplainTableQueryPlanResponse {
  ...
  public ExplainTableQueryPlanResponse context(
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPlan() != null) {
      joiner.add(
          String.format(
              "%splan%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlan()))));
    }
