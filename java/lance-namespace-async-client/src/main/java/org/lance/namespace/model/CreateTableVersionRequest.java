...
public class CreateTableVersionRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getManifestPath() != null) {
      joiner.add(String.format("%smanifest_path%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getManifestPath()))));
    }

    // add `manifest_size` to the URL query string
    if (getManifestSize() != null) {
      joiner.add(String.format("%smanifest_size%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getManifestSize()))));
    }

    // add `e_tag` to the URL query string
    if (geteTag() != null) {
      joiner.add(String.format("%se_tag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(geteTag()))));
    }
    ...
    if (getNamingScheme() != null) {
      joiner.add(String.format("%snaming_scheme%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNamingScheme()))));
    }
