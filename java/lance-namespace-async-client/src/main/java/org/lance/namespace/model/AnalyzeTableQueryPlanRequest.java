...
public class AnalyzeTableQueryPlanRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBypassVectorIndex() != null) {
      joiner.add(String.format("%sbypass_vector_index%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBypassVectorIndex()))));
    }
    ...
    if (getDistanceType() != null) {
      joiner.add(String.format("%sdistance_type%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDistanceType()))));
    }

    // add `ef` to the URL query string
    if (getEf() != null) {
      joiner.add(String.format("%sef%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEf()))));
    }

    // add `fast_search` to the URL query string
    if (getFastSearch() != null) {
      joiner.add(String.format("%sfast_search%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFastSearch()))));
    }
    ...
    if (getK() != null) {
      joiner.add(String.format("%sk%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getK()))));
    }

    // add `lower_bound` to the URL query string
    if (getLowerBound() != null) {
      joiner.add(String.format("%slower_bound%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLowerBound()))));
    }

    // add `nprobes` to the URL query string
    if (getNprobes() != null) {
      joiner.add(String.format("%snprobes%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNprobes()))));
    }
    ...
    if (getPrefilter() != null) {
      joiner.add(String.format("%sprefilter%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPrefilter()))));
    }

    // add `refine_factor` to the URL query string
    if (getRefineFactor() != null) {
      joiner.add(String.format("%srefine_factor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRefineFactor()))));
    }

    // add `upper_bound` to the URL query string
    if (getUpperBound() != null) {
      joiner.add(String.format("%supper_bound%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUpperBound()))));
    }
    ...
    if (getVectorColumn() != null) {
      joiner.add(String.format("%svector_column%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVectorColumn()))));
    }
    ...
    if (getWithRowId() != null) {
      joiner.add(String.format("%swith_row_id%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWithRowId()))));
    }
