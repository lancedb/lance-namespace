...
@JsonPropertyOrder({
  RestoreTableResponse.JSON_PROPERTY_CONTEXT,
  RestoreTableResponse.JSON_PROPERTY_TRANSACTION_ID
})
...
public class RestoreTableResponse {
  ...
  public RestoreTableResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public RestoreTableResponse putContextItem(String key, String contextItem) {
  ...
  /** Return true if this RestoreTableResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, restoreTableResponse.context)
        && Objects.equals(this.transactionId, restoreTableResponse.transactionId);
  }
