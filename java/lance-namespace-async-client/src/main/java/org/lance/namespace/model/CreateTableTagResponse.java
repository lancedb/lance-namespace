...
@JsonPropertyOrder({
  CreateTableTagResponse.JSON_PROPERTY_CONTEXT,
  CreateTableTagResponse.JSON_PROPERTY_TRANSACTION_ID
})
...
public class CreateTableTagResponse {
  ...
  public CreateTableTagResponse() {}

  public CreateTableTagResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public CreateTableTagResponse putContextItem(String key, String contextItem) {
  ...
  public CreateTableTagResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  /** Return true if this CreateTableTagResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    CreateTableTagResponse createTableTagResponse = (CreateTableTagResponse) o;
    return Objects.equals(this.context, createTableTagResponse.context)
        && Objects.equals(this.transactionId, createTableTagResponse.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTableTagResponse {\n");
