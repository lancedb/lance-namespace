...
public class InsertIntoTableRequest {
  ...
  public InsertIntoTableRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public InsertIntoTableRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public InsertIntoTableRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this InsertIntoTableRequest object is equal to o. */
  @Override
