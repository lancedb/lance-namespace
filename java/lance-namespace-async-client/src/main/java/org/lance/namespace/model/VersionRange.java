...
public class VersionRange {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getStartVersion() != null) {
      joiner.add(String.format("%sstart_version%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStartVersion()))));
    }

    // add `end_version` to the URL query string
    if (getEndVersion() != null) {
      joiner.add(String.format("%send_version%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEndVersion()))));
    }
