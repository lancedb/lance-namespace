...
public class DeclareTableResponse {
  ...
  public DeclareTableResponse storageOptions(@javax.annotation.Nullable Map<String, String> storageOptions) {
  ...
  public DeclareTableResponse properties(@javax.annotation.Nullable Map<String, String> properties) {
  ...
  public DeclareTableResponse managedVersioning(@javax.annotation.Nullable Boolean managedVersioning) {
