...
@JsonPropertyOrder({
  DeleteTableBranchRequest.JSON_PROPERTY_IDENTITY,
  DeleteTableBranchRequest.JSON_PROPERTY_CONTEXT,
  DeleteTableBranchRequest.JSON_PROPERTY_ID,
  DeleteTableBranchRequest.JSON_PROPERTY_NAME
})
...
public class DeleteTableBranchRequest {
  ...
  public DeleteTableBranchRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DeleteTableBranchRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public DeleteTableBranchRequest id(@javax.annotation.Nullable List<String> id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteTableBranchRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  /** Return true if this DeleteTableBranchRequest object is equal to o. */
  @Override
