...
public class BatchCreateTableVersionsRequest {
  ...
  private List<CreateTableVersionEntry> entries = new ArrayList<>();
  ...
  public BatchCreateTableVersionsRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public BatchCreateTableVersionsRequest entries(@javax.annotation.Nonnull List<CreateTableVersionEntry> entries) {
