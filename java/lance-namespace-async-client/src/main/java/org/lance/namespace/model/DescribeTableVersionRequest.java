...
public class DescribeTableVersionRequest {
  ...
  public DescribeTableVersionRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DescribeTableVersionRequest context(
      @javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DescribeTableVersionRequest putContextItem(String key, String contextItem) {
  ...
  public DescribeTableVersionRequest id(@javax.annotation.Nullable List<String> id) {
    this.id = id;
    return this;
  }

  public DescribeTableVersionRequest addIdItem(String idItem) {
    if (this.id == null) {
  ...
  public DescribeTableVersionRequest version(@javax.annotation.Nullable Long version) {
    this.version = version;
    return this;
  }

  /**
   * Version number to describe minimum: 0
   *
   * @return version
   */
  @javax.annotation.Nullable
  ...
  /** Return true if this DescribeTableVersionRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    DescribeTableVersionRequest describeTableVersionRequest = (DescribeTableVersionRequest) o;
  ...
  public String toString() {
    ...
    sb.append("class DescribeTableVersionRequest {\n");
