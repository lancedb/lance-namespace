...
@JsonPropertyOrder({
  ...
  DeclareTableRequest.JSON_PROPERTY_PROPERTIES
})
...
public class DeclareTableRequest {
  ...
  public DeclareTableRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public DeclareTableRequest id(@javax.annotation.Nullable List<String> id) {
    this.id = id;
    return this;
  }
  ...
  public DeclareTableRequest location(@javax.annotation.Nullable String location) {
  ...
  public DeclareTableRequest properties(@javax.annotation.Nullable Map<String, String> properties) {
  ...
  /** Return true if this DeclareTableRequest object is equal to o. */
  @Override
