...
@JsonPropertyOrder({
  AlterTableAlterColumnsResponse.JSON_PROPERTY_CONTEXT,
  AlterTableAlterColumnsResponse.JSON_PROPERTY_VERSION
})
...
public class AlterTableAlterColumnsResponse {
  ...
  public AlterTableAlterColumnsResponse context(
      @javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public AlterTableAlterColumnsResponse putContextItem(String key, String contextItem) {
  ...
  /** Return true if this AlterTableAlterColumnsResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, alterTableAlterColumnsResponse.context)
