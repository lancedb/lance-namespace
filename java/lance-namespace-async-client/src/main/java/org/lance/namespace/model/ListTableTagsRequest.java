...
@JsonPropertyOrder({
  ...
  ListTableTagsRequest.JSON_PROPERTY_CONTEXT,
...
public class ListTableTagsRequest {
  ...
  public ListTableTagsRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public ListTableTagsRequest putContextItem(String key, String contextItem) {
  ...
  public ListTableTagsRequest addIdItem(String idItem) {
    if (this.id == null) {
  ...
  public ListTableTagsRequest pageToken(@javax.annotation.Nullable String pageToken) {
  ...
  public ListTableTagsRequest limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  /** Return true if this ListTableTagsRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, listTableTagsRequest.identity)
        && Objects.equals(this.context, listTableTagsRequest.context)
