...
@JsonPropertyOrder({
  ...
  GetTableTagVersionRequest.JSON_PROPERTY_CONTEXT,
...
public class GetTableTagVersionRequest {
  ...
  public GetTableTagVersionRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  /** Return true if this GetTableTagVersionRequest object is equal to o. */
  @Override
