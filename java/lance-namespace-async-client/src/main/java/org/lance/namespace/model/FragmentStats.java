...
import org.lance.namespace.model.FragmentSummary;
...
public class FragmentStats {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNumFragments() != null) {
      joiner.add(String.format("%snum_fragments%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumFragments()))));
    }

    // add `num_small_fragments` to the URL query string
    if (getNumSmallFragments() != null) {
      joiner.add(String.format("%snum_small_fragments%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumSmallFragments()))));
    }
