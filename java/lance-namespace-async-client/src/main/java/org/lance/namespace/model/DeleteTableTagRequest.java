...
@JsonPropertyOrder({
  DeleteTableTagRequest.JSON_PROPERTY_IDENTITY,
  DeleteTableTagRequest.JSON_PROPERTY_CONTEXT,
...
public class DeleteTableTagRequest {
  ...
  public DeleteTableTagRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DeleteTableTagRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DeleteTableTagRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this DeleteTableTagRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, deleteTableTagRequest.identity)
        && Objects.equals(this.context, deleteTableTagRequest.context)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identity, context, id, tag);
  }
