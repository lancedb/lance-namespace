...
public class BatchCreateTableVersionsResponse {
  ...
  public BatchCreateTableVersionsResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  public BatchCreateTableVersionsResponse versions(@javax.annotation.Nonnull List<TableVersion> versions) {
