...
public class GetTableStatsRequest {
  ...
  public GetTableStatsRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public GetTableStatsRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this GetTableStatsRequest object is equal to o. */
  @Override
