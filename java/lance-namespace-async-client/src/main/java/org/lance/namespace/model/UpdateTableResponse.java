...
/** UpdateTableResponse */
@JsonPropertyOrder({
  UpdateTableResponse.JSON_PROPERTY_CONTEXT,
...
public class UpdateTableResponse {
  ...
  public UpdateTableResponse context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  /** Return true if this UpdateTableResponse object is equal to o. */
  @Override
