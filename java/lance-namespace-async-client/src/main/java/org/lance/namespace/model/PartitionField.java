...
import org.lance.namespace.model.PartitionTransform;
...
public class PartitionField {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFieldId() != null) {
      joiner.add(String.format("%sfield_id%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFieldId()))));
    }
