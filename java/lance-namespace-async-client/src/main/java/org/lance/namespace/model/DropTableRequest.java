 ...
 */
@JsonPropertyOrder({
  DropTableRequest.JSON_PROPERTY_IDENTITY,
  DropTableRequest.JSON_PROPERTY_CONTEXT,
  DropTableRequest.JSON_PROPERTY_ID
})
...
public class DropTableRequest {
  ...
  public DropTableRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DropTableRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DropTableRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this DropTableRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, dropTableRequest.identity)
        && Objects.equals(this.context, dropTableRequest.context)
