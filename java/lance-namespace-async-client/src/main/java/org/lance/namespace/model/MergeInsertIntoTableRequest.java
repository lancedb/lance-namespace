...
public class MergeInsertIntoTableRequest {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getOn() != null) {
      joiner.add(String.format("%son%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOn()))));
    }

    // add `when_matched_update_all` to the URL query string
    if (getWhenMatchedUpdateAll() != null) {
      joiner.add(String.format("%swhen_matched_update_all%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWhenMatchedUpdateAll()))));
    }

    // add `when_matched_update_all_filt` to the URL query string
    if (getWhenMatchedUpdateAllFilt() != null) {
      joiner.add(String.format("%swhen_matched_update_all_filt%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWhenMatchedUpdateAllFilt()))));
    }

    // add `when_not_matched_insert_all` to the URL query string
    if (getWhenNotMatchedInsertAll() != null) {
      joiner.add(String.format("%swhen_not_matched_insert_all%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWhenNotMatchedInsertAll()))));
    }

    // add `when_not_matched_by_source_delete` to the URL query string
    if (getWhenNotMatchedBySourceDelete() != null) {
      joiner.add(String.format("%swhen_not_matched_by_source_delete%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWhenNotMatchedBySourceDelete()))));
    }

    // add `when_not_matched_by_source_delete_filt` to the URL query string
    if (getWhenNotMatchedBySourceDeleteFilt() != null) {
      joiner.add(String.format("%swhen_not_matched_by_source_delete_filt%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWhenNotMatchedBySourceDeleteFilt()))));
    }

    // add `timeout` to the URL query string
    if (getTimeout() != null) {
      joiner.add(String.format("%stimeout%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTimeout()))));
    }

    // add `use_index` to the URL query string
    if (getUseIndex() != null) {
      joiner.add(String.format("%suse_index%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUseIndex()))));
    }
