...
public class CreateTableIndexRequest {
  ...
  /** Return true if this CreateTableIndexRequest object is equal to o. */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNumPartitions() != null) {
      joiner.add(
          String.format(
              "%snum_partitions%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumPartitions()))));
    }
    ...
    if (getNumSubVectors() != null) {
      joiner.add(
          String.format(
              ...
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumSubVectors()))));
    }
    ...
    if (getNumBits() != null) {
      joiner.add(
          String.format(
              "%snum_bits%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumBits()))));
    }
    ...
    if (getSampleRate() != null) {
      joiner.add(
          String.format(
              "%ssample_rate%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSampleRate()))));
    }
    ...
    if (getMaxIterations() != null) {
      joiner.add(
          String.format(
              "%smax_iterations%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxIterations()))));
    }
    ...
    if (getTargetPartitionSize() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              ApiClient.urlEncode(ApiClient.valueToString(getTargetPartitionSize()))));
    }
    ...
    if (getM() != null) {
      joiner.add(
          String.format(
              "%sm%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getM()))));
    }
    ...
    if (getEfConstruction() != null) {
      joiner.add(
          String.format(
              ...
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEfConstruction()))));
    }
