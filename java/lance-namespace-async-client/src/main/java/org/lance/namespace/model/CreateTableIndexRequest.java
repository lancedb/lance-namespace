...
public class CreateTableIndexRequest {
  ...
  public CreateTableIndexRequest removeStopWords(@javax.annotation.Nullable Boolean removeStopWords) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIndexType() != null) {
      joiner.add(String.format("%sindex_type%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIndexType()))));
    }
    ...
    if (getWithPosition() != null) {
      joiner.add(String.format("%swith_position%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getWithPosition()))));
    }

    // add `base_tokenizer` to the URL query string
    if (getBaseTokenizer() != null) {
      joiner.add(String.format("%sbase_tokenizer%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBaseTokenizer()))));
    }
    ...
    if (getMaxTokenLength() != null) {
      joiner.add(String.format("%smax_token_length%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxTokenLength()))));
    }

    // add `lower_case` to the URL query string
    if (getLowerCase() != null) {
      joiner.add(String.format("%slower_case%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLowerCase()))));
    }

    // add `stem` to the URL query string
    if (getStem() != null) {
      joiner.add(String.format("%sstem%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStem()))));
    }

    // add `remove_stop_words` to the URL query string
    if (getRemoveStopWords() != null) {
      joiner.add(String.format("%sremove_stop_words%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRemoveStopWords()))));
    }

    // add `ascii_folding` to the URL query string
    if (getAsciiFolding() != null) {
      joiner.add(String.format("%sascii_folding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAsciiFolding()))));
    }
