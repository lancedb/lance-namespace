...
public class InsertIntoTableResponse {
  ...
  public InsertIntoTableResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public InsertIntoTableResponse putContextItem(String key, String contextItem) {
  ...
  public InsertIntoTableResponse transactionId(@javax.annotation.Nullable String transactionId) {
