...
@JsonPropertyOrder({
  DeleteFromTableResponse.JSON_PROPERTY_CONTEXT,
  DeleteFromTableResponse.JSON_PROPERTY_TRANSACTION_ID,
  DeleteFromTableResponse.JSON_PROPERTY_VERSION
})
...
public class DeleteFromTableResponse {
  ...
  public DeleteFromTableResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DeleteFromTableResponse putContextItem(String key, String contextItem) {
  ...
  public DeleteFromTableResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  public DeleteFromTableResponse version(@javax.annotation.Nullable Long version) {
  ...
  /** Return true if this DeleteFromTableResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, deleteFromTableResponse.context)
        && Objects.equals(this.transactionId, deleteFromTableResponse.transactionId)
