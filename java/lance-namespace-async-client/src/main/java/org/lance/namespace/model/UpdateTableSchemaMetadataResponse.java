...
@JsonPropertyOrder({
  UpdateTableSchemaMetadataResponse.JSON_PROPERTY_CONTEXT,
  UpdateTableSchemaMetadataResponse.JSON_PROPERTY_METADATA,
  UpdateTableSchemaMetadataResponse.JSON_PROPERTY_TRANSACTION_ID
})
...
public class UpdateTableSchemaMetadataResponse {
  ...
  public UpdateTableSchemaMetadataResponse() {}

  public UpdateTableSchemaMetadataResponse context(
  ...
  public UpdateTableSchemaMetadataResponse metadata(
  ...
  public UpdateTableSchemaMetadataResponse transactionId(
  ...
  /** Return true if this UpdateTableSchemaMetadataResponse object is equal to o. */
  @Override
