...
@JsonPropertyOrder({
  ...
  TableExistsRequest.JSON_PROPERTY_CONTEXT,
...
public class TableExistsRequest {
  ...
  public TableExistsRequest context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  /** Return true if this TableExistsRequest object is equal to o. */
  @Override
