...
@JsonPropertyOrder({
  CreateTableBranchResponse.JSON_PROPERTY_CONTEXT,
  CreateTableBranchResponse.JSON_PROPERTY_TRANSACTION_ID
})
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class CreateTableBranchResponse {
  ...
  public CreateTableBranchResponse() {}

  public CreateTableBranchResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public CreateTableBranchResponse putContextItem(String key, String contextItem) {
  ...
  public CreateTableBranchResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  /** Return true if this CreateTableBranchResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    CreateTableBranchResponse createTableBranchResponse = (CreateTableBranchResponse) o;
    return Objects.equals(this.context, createTableBranchResponse.context)
        && Objects.equals(this.transactionId, createTableBranchResponse.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTableBranchResponse {\n");
