...
/** ListTablesRequest */
@JsonPropertyOrder({
  ListTablesRequest.JSON_PROPERTY_IDENTITY,
...
public class ListTablesRequest {
  ...
  public ListTablesRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public ListTablesRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public ListTablesRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this ListTablesRequest object is equal to o. */
  @Override
    ...
    if (getIncludeDeclared() != null) {
      joiner.add(
          String.format(
              ...
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIncludeDeclared()))));
    }
