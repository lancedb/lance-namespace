...
@JsonPropertyOrder({
  ...
  RenameTableRequest.JSON_PROPERTY_CONTEXT,
...
public class RenameTableRequest {
  ...
  public RenameTableRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public RenameTableRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this RenameTableRequest object is equal to o. */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identity, context, id, newTableName, newNamespaceId);
  }
