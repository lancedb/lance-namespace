...
public class BatchCommitTablesRequest {
  ...
  @javax.annotation.Nonnull private List<CommitTableOperation> operations = new ArrayList<>();
  ...
  public BatchCommitTablesRequest operations(
      @javax.annotation.Nonnull List<CommitTableOperation> operations) {
  ...
  /** Return true if this BatchCommitTablesRequest object is equal to o. */
  @Override
