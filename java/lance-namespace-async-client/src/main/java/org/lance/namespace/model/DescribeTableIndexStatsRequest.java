...
@JsonPropertyOrder({
  DescribeTableIndexStatsRequest.JSON_PROPERTY_IDENTITY,
...
public class DescribeTableIndexStatsRequest {
  ...
  public DescribeTableIndexStatsRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DescribeTableIndexStatsRequest context(
      @javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DescribeTableIndexStatsRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this DescribeTableIndexStatsRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, describeTableIndexStatsRequest.identity)
