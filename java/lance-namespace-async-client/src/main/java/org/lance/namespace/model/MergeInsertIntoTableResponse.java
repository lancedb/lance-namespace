...
public class MergeInsertIntoTableResponse {
  ...
  public MergeInsertIntoTableResponse transactionId(@javax.annotation.Nullable String transactionId) {
  ...
  public MergeInsertIntoTableResponse numUpdatedRows(@javax.annotation.Nullable Long numUpdatedRows) {
  ...
  public MergeInsertIntoTableResponse numInsertedRows(@javax.annotation.Nullable Long numInsertedRows) {
  ...
  public MergeInsertIntoTableResponse numDeletedRows(@javax.annotation.Nullable Long numDeletedRows) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNumUpdatedRows() != null) {
      joiner.add(String.format("%snum_updated_rows%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumUpdatedRows()))));
    }

    // add `num_inserted_rows` to the URL query string
    if (getNumInsertedRows() != null) {
      joiner.add(String.format("%snum_inserted_rows%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumInsertedRows()))));
    }

    // add `num_deleted_rows` to the URL query string
    if (getNumDeletedRows() != null) {
      joiner.add(String.format("%snum_deleted_rows%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNumDeletedRows()))));
    }
