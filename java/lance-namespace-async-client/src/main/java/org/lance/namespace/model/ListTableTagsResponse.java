...
@JsonPropertyOrder({
  ListTableTagsResponse.JSON_PROPERTY_CONTEXT,
...
public class ListTableTagsResponse {
  ...
  public ListTableTagsResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public ListTableTagsResponse putContextItem(String key, String contextItem) {
  ...
  /** Return true if this ListTableTagsResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, listTableTagsResponse.context)
        && Objects.equals(this.tags, listTableTagsResponse.tags)
        && Objects.equals(this.pageToken, listTableTagsResponse.pageToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(context, tags, pageToken);
  }
