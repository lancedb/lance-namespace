...
@JsonPropertyOrder({
  ListNamespacesRequest.JSON_PROPERTY_IDENTITY,
  ListNamespacesRequest.JSON_PROPERTY_CONTEXT,
...
public class ListNamespacesRequest {
  ...
  public ListNamespacesRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public ListNamespacesRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public ListNamespacesRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this ListNamespacesRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, listNamespacesRequest.identity)
        && Objects.equals(this.context, listNamespacesRequest.context)
        && Objects.equals(this.id, listNamespacesRequest.id)
