...
@JsonPropertyOrder({
  CreateNamespaceResponse.JSON_PROPERTY_CONTEXT,
...
public class CreateNamespaceResponse {
  ...
  public CreateNamespaceResponse context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  /** Return true if this CreateNamespaceResponse object is equal to o. */
  @Override
