...
public class AlterColumnsEntry {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRename() != null) {
      joiner.add(String.format("%srename%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRename()))));
    }

    // add `nullable` to the URL query string
    if (getNullable() != null) {
      joiner.add(String.format("%snullable%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNullable()))));
    }
