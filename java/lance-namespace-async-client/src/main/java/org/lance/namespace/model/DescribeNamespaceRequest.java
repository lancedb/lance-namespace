...
@JsonPropertyOrder({
  DescribeNamespaceRequest.JSON_PROPERTY_IDENTITY,
  DescribeNamespaceRequest.JSON_PROPERTY_CONTEXT,
  DescribeNamespaceRequest.JSON_PROPERTY_ID
})
...
public class DescribeNamespaceRequest {
  ...
  public DescribeNamespaceRequest identity(@javax.annotation.Nullable Identity identity) {
  ...
  public DescribeNamespaceRequest context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DescribeNamespaceRequest putContextItem(String key, String contextItem) {
  ...
  /** Return true if this DescribeNamespaceRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, describeNamespaceRequest.identity)
        && Objects.equals(this.context, describeNamespaceRequest.context)
        && Objects.equals(this.id, describeNamespaceRequest.id);
  }
