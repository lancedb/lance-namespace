...
public class BranchContents {
  ...
  /** Return true if this BranchContents object is equal to o. */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getParentBranch() != null) {
      joiner.add(
          String.format(
              "%sparentBranch%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getParentBranch()))));
    }
    ...
    if (getParentVersion() != null) {
      joiner.add(
          String.format(
              "%sparentVersion%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getParentVersion()))));
    }
    ...
    if (getCreateAt() != null) {
      joiner.add(
          String.format(
              "%screateAt%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCreateAt()))));
    }
