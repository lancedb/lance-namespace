...
/**
 * Response for a table existence check. The REST namespace does not transmit this object directly
 * (see the TableExists operation for how the status-code response maps to it). It is the standard
 * data model for the LanceNamespace interfaces (e.g. Java, Python).
 */
