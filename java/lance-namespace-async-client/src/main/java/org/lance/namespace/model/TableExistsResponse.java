...
/**
 * Response for a table existence check. This model is not used by the REST namespace, which conveys
 * existence via the HTTP status code (200 if the table exists, 404 otherwise). It is provided as a
 * standard data model for non-REST LanceNamespace interfaces (e.g. Java, Python).
 */
@JsonPropertyOrder({TableExistsResponse.JSON_PROPERTY_CONTEXT})
...
public class TableExistsResponse {
  ...
  public TableExistsResponse context(@javax.annotation.Nullable Map<String, String> context) {
    this.context = context;
    return this;
  }

  public TableExistsResponse putContextItem(String key, String contextItem) {
  ...
  /** Return true if this TableExistsResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, tableExistsResponse.context);
  }
