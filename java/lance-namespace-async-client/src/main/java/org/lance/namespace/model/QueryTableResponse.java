...
/**
 * Query results. The REST namespace does not transmit this object directly (see the QueryTable
 * operation for how the Arrow IPC binary response maps to it). It is the standard data model for
 * the LanceNamespace interfaces (e.g. Java, Python).
 */
@JsonPropertyOrder({
  QueryTableResponse.JSON_PROPERTY_CONTEXT,
  QueryTableResponse.JSON_PROPERTY_DATA
})
...
public class QueryTableResponse {
  ...
  @javax.annotation.Nullable private byte[] data;

  public QueryTableResponse() {}

  public QueryTableResponse context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public QueryTableResponse data(@javax.annotation.Nullable byte[] data) {
    this.data = data;
    return this;
  }
  ...
  /** Return true if this QueryTableResponse object is equal to o. */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getData() != null) {
      joiner.add(
          String.format(
              "%sdata%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getData()))));
    }
