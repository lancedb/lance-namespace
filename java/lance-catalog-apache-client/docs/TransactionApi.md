...
|------------- | ------------- | -------------|
| [**alterTransaction**](TransactionApi.md#alterTransaction) | **POST** /v1/transactions/{txn} | Alter information of a transaction. |
| [**getTransaction**](TransactionApi.md#getTransaction) | **GET** /v1/transactions/{txn} | Get information about a transaction |



## alterTransaction

> alterTransaction(txn, alterTransactionRequest)
...
import com.lancedb.lance.catalog.client.apache.api.TransactionApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        String txn = "txn_example"; // String | The ID of the transaction.
        AlterTransactionRequest alterTransactionRequest = new AlterTransactionRequest(); // AlterTransactionRequest | 
        try {
            apiInstance.alterTransaction(txn, alterTransactionRequest);
...
|------------- | ------------- | ------------- | -------------|
| **txn** | **String**| The ID of the transaction. | |
...
> GetTransactionResponse getTransaction(txn)
...
public class Example {
    public static void main(String[] args) {
        ...
        String txn = "txn_example"; // String | The ID of the transaction.
        try {
            GetTransactionResponse result = apiInstance.getTransaction(txn);
