...
public class Schema {
  ...
  @javax.annotation.Nonnull private Set<Field> fields = new LinkedHashSet<>();

  public Schema() {}

  public Schema metadata(@javax.annotation.Nullable Map<String, String> metadata) {
  ...
  public Schema fields(@javax.annotation.Nonnull Set<Field> fields) {
  ...
  @JsonProperty(JSON_PROPERTY_FIELDS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFields(@javax.annotation.Nonnull Set<Field> fields) {
    this.fields = fields;
  }
