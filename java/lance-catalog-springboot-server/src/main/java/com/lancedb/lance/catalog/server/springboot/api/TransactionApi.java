...
import com.lancedb.lance.catalog.server.springboot.model.AlterTransactionRequest;
...
public interface TransactionApi {
  ...
  /**
   * POST /v1/transactions/{txn} : Alter information of a transaction.
   *
  ...
  @RequestMapping(
      ...
      value = "/v1/transactions/{txn}",
      produces = {"application/json"},
      consumes = {"application/json"})
  default ResponseEntity<Void> alterTransaction(
      @Parameter(
              name = "txn",
  ...
  /**
   * GET /v1/transactions/{txn} : Get information about a transaction Return a detailed information
   * for a given transaction
   *
   * @param txn The ID of the transaction. (required)
   * @return Response for GetTransaction operation (status code 200) or Indicates a bad request
