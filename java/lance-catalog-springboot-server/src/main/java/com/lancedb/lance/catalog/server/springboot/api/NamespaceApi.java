...
public interface NamespaceApi {
  ...
  /**
   * DELETE /v1/namespaces/{ns} : Drop a namespace from the catalog Drop a namespace from the
   * catalog. If the operation can be completed immediately, the server should respond with 204. If
   * the operation is long running, the server should respond with 202 to provide a transaction that
   * the client can use to track namespace drop progress.
   *
