...
public class GetTableTagVersionRequest {
  ...
  public GetTableTagVersionRequest identity(Identity identity) {
  ...
  public GetTableTagVersionRequest context(Map<String, String> context) {
    this.context = context;
    return this;
  }

  public GetTableTagVersionRequest putContextItem(String key, String contextItem) {
   ...
   */
  @NotNull 
  @Schema(name = "tag", description = "Name of the tag to get version for", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("tag")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identity, getTableTagVersionRequest.identity) &&
        Objects.equals(this.context, getTableTagVersionRequest.context) &&
