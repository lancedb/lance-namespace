...
public class ListTableBranchesRequest {
  ...
  public ListTableBranchesRequest identity(Identity identity) {
  ...
  public ListTableBranchesRequest context(Map<String, String> context) {
  ...
  public ListTableBranchesRequest id(List<String> id) {
    this.id = id;
    return this;
  }
  ...
  public ListTableBranchesRequest pageToken(String pageToken) {
  ...
  public ListTableBranchesRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
