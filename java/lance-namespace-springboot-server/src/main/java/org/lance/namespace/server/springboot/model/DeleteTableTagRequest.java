...
public class DeleteTableTagRequest {
  ...
  public DeleteTableTagRequest context(Map<String, String> context) {
   ...
   */
  @NotNull 
  @Schema(name = "tag", description = "Name of the tag to delete", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("tag")
