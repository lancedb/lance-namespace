...
@Schema(name = "DropTableRequest", description = "If the table and its data can be immediately deleted, return information of the deleted table. Otherwise, return a transaction ID that client can use to track deletion progress. ")
...
public class DropTableRequest {
  ...
  public DropTableRequest context(Map<String, String> context) {
