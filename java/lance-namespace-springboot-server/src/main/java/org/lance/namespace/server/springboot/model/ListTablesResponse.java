...
public class ListTablesResponse {
   ...
   */
  @NotNull 
  @Schema(name = "tables", description = "The list of names of all the tables under the connected namespace implementation. This should recursively list all the tables in all child namespaces. Each string in the list is the full identifier in string form. ", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("tables")
