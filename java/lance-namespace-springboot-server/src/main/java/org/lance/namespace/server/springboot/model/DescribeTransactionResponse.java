...
public class DescribeTransactionResponse {
  ...
  public DescribeTransactionResponse(String status) {
    this.status = status;
  }

  public DescribeTransactionResponse context(Map<String, String> context) {
    this.context = context;
    return this;
  }

  public DescribeTransactionResponse putContextItem(String key, String contextItem) {
  ...
  public DescribeTransactionResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, describeTransactionResponse.context)
