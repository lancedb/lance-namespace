...
@Schema(name = "VersionRange", description = "A range of versions to delete (start inclusive, end exclusive). Special values: - `start_version: 0` with `end_version: -1` means ALL versions ")
...
public class VersionRange {
   ...
   */
  @NotNull 
  @Schema(name = "start_version", description = "Start version of the range (inclusive). Use 0 to start from the first version. ", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "end_version", description = "End version of the range (exclusive). Use -1 to indicate all versions up to and including the latest. ", requiredMode = Schema.RequiredMode.REQUIRED)
