...
public class ListTableTagsRequest {
  ...
  public ListTableTagsRequest context(Map<String, String> context) {
  ...
  public ListTableTagsRequest pageToken(String pageToken) {
  ...
  public ListTableTagsRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
