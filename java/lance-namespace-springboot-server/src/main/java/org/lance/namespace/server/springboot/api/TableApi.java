...
public interface TableApi {
  ...
  /**
   * POST /v1/table/{id}/create_materialized_view : Create a materialized view Create a materialized
   * view at table identifier &#x60;id&#x60;. The view may be query-backed, UDTF-backed, or
   * chunker-backed, controlled by the &#x60;kind&#x60; discriminator.
   *
   * @param id &#x60;string identifier&#x60; of an object in a namespace, following the Lance
   *     Namespace spec. When the value is equal to the delimiter, it represents the root namespace.
   *     For example, &#x60;v1/namespace/$/list&#x60; performs a &#x60;ListNamespace&#x60; on the
  ...
  @RequestMapping(
      method = RequestMethod.POST,
      value = "/v1/table/{id}/create_materialized_view",
      produces = {"application/json"},
      consumes = {"application/json"})
  ...
  /**
   * POST /v1/table/{id}/refresh : Trigger an async materialized view refresh Trigger an
   * asynchronous refresh job for a materialized view backed by table &#x60;id&#x60;. Returns a job
   * ID for tracking.
   *
   * @param id &#x60;string identifier&#x60; of an object in a namespace, following the Lance
   *     Namespace spec. When the value is equal to the delimiter, it represents the root namespace.
