...
@Schema(name = "DeleteTableBranchResponse", description = "Response for delete branch operation")
@Generated(
...
public class DeleteTableBranchResponse {
  ...
  public DeleteTableBranchResponse context(Map<String, String> context) {
  ...
  public DeleteTableBranchResponse transactionId(String transactionId) {
