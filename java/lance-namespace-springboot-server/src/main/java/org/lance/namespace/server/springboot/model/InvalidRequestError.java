...
@Schema(name = "InvalidRequestError", description = "Malformed request or validation failure")
@Generated(
    value = "org.openapitools.codegen.languages.SpringCodegen",
    comments = "Generator version: 7.12.0")
public class InvalidRequestError
    implements AlterTableAddColumns400Response,
  ...
  public InvalidRequestError(String error, CodeEnum code, TypeEnum type) {
    this.error = error;
    this.code = code;
    this.type = type;
  }

  public InvalidRequestError error(String error) {
    this.error = error;
    return this;
  }
  ...
  public InvalidRequestError code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public InvalidRequestError type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public InvalidRequestError detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public InvalidRequestError instance(String instance) {
