...
@Schema(name = "CreateTableBranchResponse", description = "Response for create branch operation")
@Generated(
...
public class CreateTableBranchResponse {
  ...
  public CreateTableBranchResponse context(Map<String, String> context) {
  ...
  public CreateTableBranchResponse transactionId(String transactionId) {
